<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\WWW\transport\public/../application/index\view\inland\inlandcoldchain.html";i:1508720649;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
                ...
                <div class="ejdh">
                    ...
                    <div class="zy_dh_lb">
                        <ul>
                            ...
                            <li><a href="<?php echo url('Inland/inlandmoney'); ?>"><span class="glyphicon glyphicon-play"></span>&nbsp;国内订车</a></li>
                            ...
                            <div class="trace_l internation" style="width: 100%">
                                ...
                                <div class="border1">
                                    ...
                                    <div class="aboutus">
                                        <div class="fl aboutus_l">
                                            <p class="indent">
                                                干线运输主要以冷藏箱公路运输为主，将货物送达目的地，适合大容量、大吨位，长途运输服务。主要承运商品为冷冻冷藏肉、速冻食品、果蔬、冰淇淋、冰冻水产品、奶糖制品（含其它）。服务特性：干线公路运输，24小时提货送货，全部专业冷藏车， 配备GPS+北斗导航系统+多温区温感设备，运输过程可视化。
                                            </p>
                                        </div>
                                        <div class="fr aboutus_r"><img class="img1" src="__PUBLIC__/images/gx.jpg" alt=""></div>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="border1">
                                    ...
                                    <div class="aboutus">
                                        <div class="fl aboutus_l">
                                            <p class="indent">
                                                支线运输主要以冷藏箱公路运输为主，将货物送达目的地，适合小批量、小吨位、短途运输服务。主要承运商品为冷冻冷藏肉、速冻食品、果蔬、冰淇淋、冰冻水产品、奶糖制品（含其它）。服务特性： 全程监控、实时监控、定制化服务。
                                            </p>
                                        </div>
                                        <div class="fr aboutus_r"><img class="img1" src="__PUBLIC__/images/zx.jpg" alt=""></div>
                                        <div class="clearfix"></div>
                                    </div>
                                ...
                                <div class="border1">
                                    ...
                                    <div class="aboutus">
                                        <div class="fl aboutus_l">
                                            ...
                                            <p class="indent">2、连锁餐饮冷链服务：自制冷冻车或配备多温车，根据分店位置制定最佳派送方案，提供“门”到“门”服务。</p>
                                        </div>
                                        <div class="fr aboutus_r"><img class="img1" src="__PUBLIC__/images/csps.jpg" alt=""></div>
                                        <div class="clearfix"></div>
                                    </div>
