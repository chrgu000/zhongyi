<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"E:\WWW\transport\public/../application/index\view\personalcenterorder\order_carfindgoods_detail.html";i:1509006742;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1508989819;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1507716955;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
          ...
          <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
            ...
            <div class="orderdetail">
              <h3>
                ...
                <a class="back" href="<?php echo url('Personalcenterorder/acceptorder_path'); ?>">返回</a>
                <div class="clearfix"></div>
              </h3>
                  ...
                  <!-- 车主信息 -->
                    <td>
                      ...
                      <ul class="u-inforUl detail">
                        ...
                        <li class="clearfix"><a>认证类型： </a>
                          <span>
                            <?php if(is_array($type_id) || $type_id instanceof \think\Collection || $type_id instanceof \think\Paginator): $i = 0; $__LIST__ = $type_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;if($vo3['id'] == $userres3['type_id']): ?>
                                <?php echo $vo3['typename']; endif; endforeach; endif; else: echo "" ;endif; ?>
                            &nbsp;
                            <?php if($userres3['type'] != ''): ?>
                              (<?php echo $userres3['type']; ?>)
                              <?php else: endif; ?>
                          </span>
                        </li>
                      </ul>
