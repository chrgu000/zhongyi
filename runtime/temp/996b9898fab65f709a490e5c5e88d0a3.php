<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\wamp\www\transport\public/../application/admin\view\user\User-edit.html";i:1507533684;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('User/edit'); ?>" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5"> <span class="select-box">
                <select class="select" size="1" name="type"  nullmsg="请选择认证类型！">
        ...
        <div class="row cl">
            <label class="form-label col-3">账号类别：</label>
            <div class="formControls col-5 skin-minimal">
            <?php if($list['is_company'] == 0): ?>
                <div class="radio-box">
                    <input type="radio" id="sex-1" name="is_company" value="1" >
                    <label for="sex-1">自营账号</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="is_company" value="0" checked="checked"> 
                    <label for="sex-2">非自营账号</label>
                </div>
            <?php elseif($list['is_company'] == 1): ?>
                <div class="radio-box">
                    <input type="radio" id="sex-1" name="is_company" value="1" checked="checked" >
                    <label for="sex-1">自营账号</label>
                </div>
                <div class="radio-box">
        ...
        <?php if($list['type'] == '公司货主'): ?>
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input name="company_name" type="text" class="input-text" value="<?php echo $list['company_name']; ?>" >
                </div>
                <div class="col-4"> </div>
            </div>  
            <div class="row cl">
        ...
        <?php elseif($list['type'] == '个体货主'): ?>
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input name="real_name" type="text" class="input-text" value="<?php echo $list['real_name']; ?>">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3">身份证号：</label>
                <div class="formControls col-5">
                    <input name="identity_id" type="text" class="input-text" value="<?php echo $list['identity_id']; ?>">
                </div>
                <div class="col-4"> </div>
            </div>
            <div class="row cl">
        ...
        <?php elseif($list['type'] == '车主'): ?>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-5">
                    <input name="car_id" type="text" class="input-text" value="<?php echo $list['car_id']; ?>" >
                </div>
                <div class="col-4"> </div>
            </div>
            <div class="row cl">
