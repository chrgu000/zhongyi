<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"E:\WWW\transport\public/../application/index\view\personalcenter\warehouseadd.html";i:1510107983;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1509590134;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                 <p class="p1 active">添加仓库</p>
            </div>
            <form id="addCarGoodsResource" enctype="multipart/form-data" method="post" novalidate="novalidate" class="form1" onSubmit="return checkwarehouse();">
            ...
            <?php endif; ?>
                <div class="rz-Form" style="margin-left: 200px;">
                    <div class="rz-model rz-label">
                        ...
                        <input onblur="mzReg(this)" name="wh_name" id="idCard" class="sfz" type="text" placeholder="请输入仓库名称">
                        <label>请输入仓库名称</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <div class="ku" style="display: inline-block;">
                            <input onblur="mzReg(this)" name="wh_address" id="name" class="xm" type="text" placeholder="请输入仓库地址" >
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <input onblur="mzReg(this)" name="wh_address_detail" id="idCard" class="sfz" type="text" placeholder="请输入详细地址">
                        <label>请输入详细地址</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <input onblur="xsReg(this)" name="wh_price" id="idCard" class="sfz" type="text" placeholder="请输入仓库价格" style="width: 230px;">
                        <select name="wh_price_type" class="siteselect" style="width: 230px;">
                            <option value="0">元/天/托</option>
                            <option value="1">元/天/平</option>
                            <option value="2">元/天/吨</option>
                            <option value="3">元/天/方</option>
                        </select>
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <div class="libraryarea">
                            <input type="checkbox" name="wh_type[]" value="平堆库">&nbsp;平堆库
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="wh_type[]" value="货架库">&nbsp;货架库
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="wh_type[]" value="自动化库">&nbsp;自动化库
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="wh_type[]" value="保税库">&nbsp;保税库
                        </div>
                        <label>请选择仓库类型</label>
                    </div>
                    <div class="rz-model rz-label">
                        ...
                        <div class="libraryarea">
                            <input type="radio" name="wh_invoice" value="提供发票">&nbsp;提供发票
                        </div>
                        <div class="libraryarea">
                            <input type="radio" name="wh_invoice" checked="" value="不提供发票">&nbsp;不提供发票
                        </div>
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <div class="libraryarea">
                            <input type="checkbox" name="wh_service[]" value="提供拖车">&nbsp;提供拖车
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="wh_service[]" value="提供装卸">&nbsp;提供装卸
                        </div>
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <div class="libraryarea">
                            <span>常温</span>
                            <input onblur="xsReg(this)" name="normal_area" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;平方&nbsp;</span>
                            <input onblur="xsReg(this)" name="normal_volume" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;立方&nbsp;</span>
                            <label>请输入正确格式的仓库面积</label>
                        </div>
                        <div class="libraryarea">
                            <span>冷藏</span>
                            <input onblur="xsReg(this)" name="coldstorage_area" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;平方&nbsp;</span>
                            <input onblur="xsReg(this)" name="coldstorage_volume" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;立方&nbsp;</span>
                            <label>请输入正确格式的仓库面积</label>
                        </div>
                        <div class="libraryarea">
                            <span>冷冻</span>
                            <input onblur="xsReg(this)" name="freeze_area" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;平方&nbsp;</span>
                            <input onblur="xsReg(this)" name="freeze_volume" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;立方&nbsp;</span>
                            <label>请输入正确格式的仓库面积</label>
                        </div>
                        <div class="libraryarea">
                            <span>急冻</span>
                            <input onblur="xsReg(this)" name="quickfreeze_area" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;平方&nbsp;</span>
                            <input onblur="xsReg(this)" name="quickfreeze_volume" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;立方&nbsp;</span>
                            <label>请输入正确格式的仓库面积</label>
                        </div>
                        <div class="libraryarea">
                            <span>深冷</span>
                            <input onblur="xsReg(this)" name="deepcold_area" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;平方&nbsp;</span>
                            <input onblur="xsReg(this)" name="deepcold_volume" id="name" class="xm" type="text" placeholder="请输入仓库面积" style="width: 200px;">
                            <span>&nbsp;立方&nbsp;</span>
                            <label>请输入正确格式的仓库面积</label>
                        </div>
                    </div>
                    <!-- <div class="rz-model rz-label">
                        ...
                        <div class="libraryarea">
                            <input onblur="mzReg(this)" name="useable_area" id="name" class="xm" type="text" placeholder="请输入可用库存" style="width: 200px;">
                            <span>&nbsp;平方&nbsp;</span>
                            <input onblur="mzReg(this)" name="useable_volume" id="name" class="xm" type="text" placeholder="请输入可用库存" style="width: 200px;">
                            <span>&nbsp;立方&nbsp;</span>
                        </div>
                    </div> -->
                     <div class="clearfix rz-model">
                        ...
                        <span class="fileinput-button">
                            <span>点击上传</span>
                            <input type="file" name="wh_photo" id='file'; onchange="c()" class="sfz"  placeholder="请上传仓库图片">
                        </span>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <input onblur="mzReg(this)" name="wh_contact" id="idCard" class="sfz" type="text" placeholder="请输入联系人姓名">
                        <label>请输入联系人</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <input onblur="uxPhone(this)" name="wh_phone" id="idCard" class="sfz" type="text" placeholder="请输入联系电话">
                        <label>请输入联系电话</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <textarea name="wh_remark" class="remark" maxlength="30" ></textarea>
...
<script type="text/javascript">
    ...
    $('.person-left dl').eq(5).find('.hideleft').find('dd').eq(0).addClass('active'); 
</script>
</body>
</html>