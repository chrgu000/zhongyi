<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"E:\WWW\transport\public/../application/index\view\personalcenterorder\order_path_detail.html";i:1508896133;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508719130;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1508765778;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1507716955;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
          ...
          <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
            ...
            <div class="orderdetail">
              <h3>
                ...
                <a class="back" href="<?php echo url('Personalcenterorder/acceptorder_goodscar'); ?>">返回</a>
                <div class="clearfix"></div>
              </h3>
                ...
                <span style="float: right;">订单状态：
                  <?php if($v1['car_state'] == '1'): ?>
                    ...
                    <?php elseif($v1['car_state'] == '3'): ?>
                      订单已支付，待发车
                    <?php elseif($v1['car_state'] == '4'): ?>
                      已发车，货物运输中
                    <?php elseif($v1['car_state'] == '5'): if($v1['order_state'] == '4'): ?>
                        交易完成，等待平台支付
                      <?php elseif($v1['order_state'] == '5'): ?> 
                        交易完成，平台已支付
                      <?php endif; else: ?>
                      交易取消
                  <?php endif; ?>
