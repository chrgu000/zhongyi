                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">
                            <table style="min-width:960px;">
                                <tbody>
                                    ...
                                    <?php if($warehouseres != ''): if(empty($order_warehouseres) != true): if(is_array($order_warehouseres) || $order_warehouseres instanceof \think\Collection || $order_warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_warehouseres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> 
                                                    ...
                                                    <td class="" style="width:17%;">
                                                        <div class="skin-list2">
                                                            ...
                                                            <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                    ...
                                                                    <p class="ellipsis" title="<?php echo $v2['whaddress_detail']; ?>"> <?php echo $v2['whaddress_detail']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
