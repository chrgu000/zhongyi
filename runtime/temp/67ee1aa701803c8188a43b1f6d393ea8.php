<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\WWW\transport\public/../application/index\view\service\goodstrace.html";i:1513930843;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
﻿<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="ziye_bj" style="float: none;">
    <div class="ziye_tu">
        <img src="__IMG__<?php echo $banner['goodstrace']; ?>">
    </div>
</div>
<!-- 内容开始 -->
<div class="goodstrace wrap-1200">
    <div class="trace_l fl">
        <h3>实时货物追踪</h3>
        <p class="des">通过GPS、GIS、移动互联网、物联网、大数据、云计算，实时监控车辆的运行状态、行驶轨迹、车内温度，托运方用户可以实时了解货物在途位置和货物状态。</p>
        <p class="item"><span class="item-ok glyphicon glyphicon-ok"></span>&nbsp;&nbsp;&nbsp;GPS、GIS</p>
        <p class="item"><span class="item-ok glyphicon glyphicon-ok"></span>&nbsp;&nbsp;&nbsp;移动互联网</p>
        <p class="item"><span class="item-ok glyphicon glyphicon-ok"></span>&nbsp;&nbsp;&nbsp;物联网</p>
        <p class="item"><span class="item-ok glyphicon glyphicon-ok"></span>&nbsp;&nbsp;&nbsp;大数据</p>
        <p class="item"><span class="item-ok glyphicon glyphicon-ok"></span>&nbsp;&nbsp;&nbsp;云计算</p>
    </div>
    <div class="trace_r fr">
        <img class="gps" src="__PUBLIC__/images/gps1.png">
        <!-- <img class="gps" src="__PUBLIC__/images/gps1.jpg"> -->
    </div>
    <div class="clearfix"></div>
</div>
<!-- 内容结束 -->
