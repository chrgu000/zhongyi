<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\WWW\transport\public/../application/admin\view\publicmeg\public-add.html";i:1511919176;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Publicmeg/add'); ?>" method="post" class="form form-horizontal" id="form-admin-add" >
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" name="writernum" class="input-text" value="<?php echo $writernum; ?>" readonly="true">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>发布者姓名：</label>
			<div class="formControls col-4">
				<input type="text" name="writer" class="input-text" value="<?php echo $writer; ?>" readonly="true" >
			</div>
		</div>
		<div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>资讯描述：</label>
            <div class="formControls col-8">
                <textarea name="text" class="textarea"  placeholder="请输入公告内容..." nullmsg="内容不能为空！"  datatype="*"></textarea>
            </div>
            <div class="col-1"> </div>
        </div>
		<div class="row cl">
