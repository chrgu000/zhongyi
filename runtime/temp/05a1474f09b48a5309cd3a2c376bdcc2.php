<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\wamp\www\transport\public/../application/index\view\index\index.html";i:1506561738;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506762234;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<div class="head clearfix" style="overflow: visible;">
    ...
    <div class="wrap-1200 mycar_wrap">
        <div class="fl mycar mygoods">
            <div class="title" >
                <p style="display: inline-block;"><span class="fa fa-cubes">&nbsp;易冷链货源</p>
        ...
        <div class="fr mycar" >
            <div class="title" style="width: 100%;">
                <p style="display: inline-block;"><span class="fa fa-truck">&nbsp;易冷链车源</p>
                        ...
                        <li>
                            <a href="<?php echo url('Path/path_detail',array('id'=>$v1['id'])); ?>">
                                ...
                                <p class="item iteme skin">
                                    ...
                                    <br>
                                    <span>常用车长：</span><span title="<?php echo $v1['vehicle_length']; ?>"><?php echo $v1['vehicle_length']; ?><?php echo $v1['vehicle_length']; ?></span>
                                </p>
            ...
            <div class="index_gsgk">
                ...
                <div class="index_gsgk_n">
                    ...
                    <p style="text-align: justify; text-indent: 30px;">
                      陆港易冷链采用自主知识产权恒温冷藏箱，配备GPS定位系统，实时远程监控，全程冷链可追溯，保证货物质量与安全。且已形成密集的运输网络，在各大网络中心点设有完整的操作设备和场站，拥有长期专业运输车队，有效减少运输时间，实现高效运输作业。<!-- 以完善的运输管理系统和标准化的操作模式，为客户提供专业、透明、全程可追溯的冷链运输服务。 --></p>
