<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\wamp\www\transport\public/../application/admin\view\usertype\usertype-add.html";i:1506419456;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Usertype/add'); ?>" method="post" class="form form-horizontal">
    <div class="row cl">
