<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"E:\WWW\transport\public/../application/index\view\personalcenterorder\acceptorder_goodscar.html";i:1511165437;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <?php if($userres['type'] == '物流公司'): ?>
                    <a href="<?php echo url('Personalcenterorder/acceptorder_goodscar'); ?>"><p class="p1 active">货找车订单</p></a>
                    <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku'); ?>"><p class="p2">货找库订单</p></a>
                    <a href="<?php echo url('Personalcenterorder/acceptorder_path'); ?>"><p class="p3 ">车主抢单</p></a>
            ...
            <div class="m-infortabBack">
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenterorder/acceptorder_goodscar'); ?>" method="get" class="searchform">
                                ...
                                <div class="clearfix fl m30">
                                    ...
                                    <div class="fr">
                                        <select name="order_state" class="siteselect" style="width: 150px;">
                                            <option >不限</option>
                                            <option value="1" <?php if($order_state == '1'): ?> selected="selected"<?php endif; ?> >待确认</option>
                                            <option value="2" <?php if($order_state == '2'): ?> selected="selected"<?php endif; ?> >待付款</option>
                                            <option value="3" <?php if($order_state == '3'): ?> selected="selected"<?php endif; ?> >待发车</option>
                                            <option value="4" <?php if($order_state == '4'): ?> selected="selected"<?php endif; ?> >运输中</option>
                                            <option value="5" <?php if($order_state == '5'): ?> selected="selected"<?php endif; ?> >已完成</option>
                                            <option value="6" <?php if($order_state == '6'): ?> selected="selected"<?php endif; ?> >已取消</option>
                                        </select>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">
                            <table style="min-width:960px;">
                                <tbody>
                                    ...
                                    <?php if(empty($pathres) != true): if(empty($order_pathres) != true): if(is_array($order_pathres) || $order_pathres instanceof \think\Collection || $order_pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_pathres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                    
                                                <tr class="ky-ddKK ky-ddKK1 odd">
                                                    <td class="zc-lastTr " style="width:12%;">
                                                        <div class="skin-list3">
                                                        <?php if(is_array($pathres) || $pathres instanceof \think\Collection || $pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $pathres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['path_id'] == $v1['id']): ?>
                                                                <p class="ellipsis" title=" <?php echo $v1['startsite']; ?>"  style="text-align:left;">&nbsp;<span class="fa fa-map-marker faicon1"></span>始：<?php echo $v1['startsite']; ?></p>
                                                                <p class="ellipsis" title="<?php echo $v1['endsite']; ?> " style="text-align:left;">&nbsp;<span class="fa fa-map-marker faicon2"></span>到：<?php echo $v1['endsite']; ?></p>
                                                    ...
                                                    <td class="" style="width:12%;">
                                                        <div class="skin-list3">
                                                            ...
                                                            <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                    <p class="ellipsis" title=" <?php echo $v2['starting_address']; ?>"  style="text-align:left;">&nbsp;始：<?php echo $v2['starting_address']; ?></p>
                                                                    <p class="ellipsis" title="<?php echo $v2['destination']; ?>" style="text-align:left;">&nbsp;到：<?php echo $v2['destination']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="" style="width:15%;">
                                                        ...
                                                        <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                ...
                                                                <?php if(is_array($car_length) || $car_length instanceof \think\Collection || $car_length instanceof \think\Paginator): $i = 0; $__LIST__ = $car_length;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v6): $mod = ($i % 2 );++$i;if($v6['id'] == $v2['car_length']): ?>
                                                                        <?php echo $v6['typename']; endif; endforeach; endif; else: echo "" ;endif; ?>
                                                                的</br>
                                                                <?php if(is_array($car_type) || $car_type instanceof \think\Collection || $car_type instanceof \think\Paginator): $i = 0; $__LIST__ = $car_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v3): $mod = ($i % 2 );++$i;if($v3['id'] == $v2['car_type']): ?>
                                                    ...
                                                    <td class="" style=" width:10%;">
                                                        <div class="skin-list1">
                                                        <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                <p class="">从<?php echo $v2['start_loadingtime']; ?></br>到<?php echo $v2['end_loadingtime']; ?></p>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    <td class="" style="width: 10%">
                                                        <div class="skin-list1">
                                                            <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                    <p class="">从<?php echo $v2['start_arrivetime']; ?></br>到<?php echo $v2['end_arrivetime']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="" style="width: 13%">
                                                        <div class="skin-list1">
                                                            ...
                                                            <?php elseif($vo['car_state'] == '4'): ?>
                                                                运输中
                                                            <?php elseif($vo['car_state'] == '5'): if($vo['order_state'] == '4'): ?>
                                                                    交易完成<br/>等待平台支付
                                                                <?php elseif($vo['order_state'] == '5'): ?> 
                                                                    交易完成<br/>平台已支付
                                                                <?php endif; else: ?>
                                                                交易取消
                                                            <?php endif; ?>
                                                    ...
                                                    <?php if($vo['car_state'] == '1'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/carsure',array('id'=>$vo['id'])); ?>" class="btn1" title="确认接受订单吗" onClick="return confirm('确认要接受订单吗？')" datatype="1"><span class="glyphicon glyphicon-ok-circle"></span></a>
                                                    ...
                                                    <?php elseif($vo['car_state'] == '3'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/depart1',array('id'=>$vo['id'])); ?>" class="btn1" title="确定发车" onClick="return confirm('确定您已发车吗？')" datatype="1"><span class="fa fa-truck"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/paid_cancel2',array('id'=>$vo['id'])); ?>" class="btn1" title="取消订单" datatype="1" onClick="return confirm('确定要取消订单吗？')"><span class="glyphicon glyphicon-remove-circle"></span></a>
                                                            </div>
                                                        </td> 
                                                    <?php elseif($vo['car_state'] == '4'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/finish3',array('id'=>$vo['id'])); ?>" class="btn1" title="确认货物送达" datatype="1" onClick="return confirm('确认货物已送达目的吗吗？')"><span class="glyphicon glyphicon-saved"></span></a>
                                                            </div>
                                                        </td> 
                                                    <?php elseif($vo['car_state'] == '5'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/car_del1',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                            </div>
                                                        </td> 
                                                    <?php else: ?>
                                                        <td class="" style="width: 8%">
                                            ...
                                            <?php endforeach; endif; else: echo "<p class='nulltext'>暂时没有数据</p>" ;endif; endif; else: ?>
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($pathres) != true): if($order_pathres->isEmpty()): else: ?>
                                            <?php echo $order_pathres->render(); ?>
                            ...
                            <!-- <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($pathres) != true): if($order_pathres->isEmpty()): else: ?>
                                            <?php echo $order_pathres->render(); endif; endif; ?>
                                </div>
                            </div>  -->
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/acceptorder_goodscar.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
