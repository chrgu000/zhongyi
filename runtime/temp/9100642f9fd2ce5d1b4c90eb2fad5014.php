<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"E:\WWW\transport\public/../application/index\view\personalcenterorder\myorder_findcar.html";i:1511164600;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>我的抢单-找车订单</title>
            ...
            <div class="m-infortabBack" style="margin-top: 20px;">
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenterorder/myorder_findcar'); ?>" method="get" class="searchform">
                                ...
                                <div class="clearfix fl m30">
                                    ...
                                    <div class="fr">
                                        <select name="order_state" class="siteselect" style="width: 150px;">
                                            ...
                                            <option value="7" <?php if($order_state == '7'): ?> selected="selected"<?php endif; ?> >退款中</option>
                                        </select>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">                            
                            <table style="min-width:960px;" class="table1">
                                <tbody>
                                    ...
                                    <?php if(empty($goodsres) != true): if(empty($order_pathres) != true): if(is_array($order_pathres) || $order_pathres instanceof \think\Collection || $order_pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_pathres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                       
                                                <tr class="ky-ddKK ky-ddKK1 odd">
                                                    ...
                                                    <td class="" style="width:12%;">
                                                        <div class="skin-list1">
                                                            ...
                                                            <?php if(is_array($pathres) || $pathres instanceof \think\Collection || $pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $pathres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['path_id'] == $v1['id']): ?>
                                                                    <p class="ellipsis" style="text-align: left;" title="<?php echo $v1['startsite']; ?>"> <span class="fa fa-map-marker faicon1"></span>始：<?php echo $v1['startsite']; ?></p>
                                                                    <p class="ellipsis" style="text-align: left;" title="<?php echo $v1['endsite']; ?>"><span class="fa fa-map-marker faicon2"></span>到： <?php echo $v1['endsite']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>    
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="" style="width:10%;">
                                                        ...
                                                        <?php if(is_array($pathres) || $pathres instanceof \think\Collection || $pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $pathres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['path_id'] == $v1['id']): ?>
                                                                <p class="ellipsis" title="<?php echo $v1['vehicle_type']; ?>"><?php echo $v1['vehicle_type']; ?></p>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    <td class="" style=" width:10%;">
                                                        <div class="skin-list3">
                                                        <?php if(is_array($pathres) || $pathres instanceof \think\Collection || $pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $pathres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['path_id'] == $v1['id']): ?>
                                                                <p class="ellipsis" title="<?php echo $v1['vehicle_length']; ?>"><?php echo $v1['vehicle_length']; ?></p>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    <td class="" style="width: 12%">
                                                        <div class="skin-list3">
                                                        <?php if(is_array($pathres) || $pathres instanceof \think\Collection || $pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $pathres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['path_id'] == $v1['id']): ?>
                                                                <p class=""><?php echo $v1['linkman']; ?></p>
                                                                <p class="ellipsis"><?php echo $v1['linkphone']; ?></p>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    <td class="" style="width: 10%">
                                                    ...
                                                    <?php if($vo['pay_state'] == '1'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            ...
                                                            <div class="modal fade" id="<?php echo $vo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="md-content">
                                                                            ...
                                                                            <div>
                                                                                <ul class="order_ku">
                                                                                <form action="<?php echo url('Personalcenterorder/alipay3'); ?>" method="post" class="rz-Form">
                                                    ...
                                                    <?php elseif($vo['pay_state'] == '4'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/finish2',array('id'=>$vo['id'])); ?>" class="btn1" title="确认货物送达" datatype="1" onClick="return confirm('确认货物已送达目的吗吗？')"><span class="glyphicon glyphicon-saved"></span></a>
                                                            </div>
                                                        </td> 
                                                    <?php elseif($vo['pay_state'] == '5'): ?>
                                                        <td class="" style="width: 8%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/order_path_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/goods_del3',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                            </div>
                                                        </td> 
                                                    <?php elseif($vo['pay_state'] == '6'): ?>
                                                        <td class="" style="width: 8%">
                            ...
                            <style type="text/css">
                             ...
                             <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($goodsres) != true): if($order_pathres->isEmpty()): else: ?>
...
<script type="text/javascript">
   ...
   $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/myorder_findcar.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
