<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\WWW\zhongyi\public/../application/admin\view\user\list.html";i:1524564884;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20 nullwrap">
	...
	<form action="<?php echo url('User/lst'); ?>" method="get">		
		<input type="text" class="input-text" style="width:250px" placeholder="请输入用户名" id="" name="keywords" value="">
