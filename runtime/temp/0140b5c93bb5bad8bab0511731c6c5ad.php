<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"E:\WWW\transport\public/../application/index\view\personalcenterorder\myorder_findgoodscar.html";i:1511165385;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>我的抢单-车找货</title>
            ...
            <div class="m-infortabBack" style="margin-top: 20px;">
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenterorder/myorder_findgoodscar'); ?>" method="get" class="searchform">
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">                            
                            <table style="min-width:960px;" class="table1">
                                <tbody>
                                    ...
                                    <?php if(empty($order_goodscarres) != true): if(is_array($order_goodscarres) || $order_goodscarres instanceof \think\Collection || $order_goodscarres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_goodscarres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                       
                                            <tr class="ky-ddKK ky-ddKK1 odd">
                                                <td class="zc-lastTr " style="width:20%;">
                                                    <div class="skin-list1">
                                                        <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                <p class="ellipsis" title=" <?php echo $v2['starting_address']; ?>" style="text-align: left;">&nbsp;<span class="fa fa-map-marker faicon1"></span>始：<?php echo $v2['starting_address']; ?></p>
                                                                <p class="ellipsis" title="<?php echo $v2['destination']; ?> " style="text-align: left;">&nbsp;<span class="fa fa-map-marker faicon2"></span>到：<?php echo $v2['destination']; ?></p>
                                                ...
                                                <td class="" style="width:15%;">
                                                    <div class="skin-list2">
                                                        <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                <p> 
                                                                <?php echo $v2['goods_name']; ?>，<?php echo $v2['standard_ton']; ?>吨，<?php echo $v2['standard_square']; ?>方
                                                                </br>求：
                                                                ...
                                                                <?php if(is_array($payment_mode) || $payment_mode instanceof \think\Collection || $payment_mode instanceof \think\Paginator): $i = 0; $__LIST__ = $payment_mode;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v4): $mod = ($i % 2 );++$i;if($v4['id'] == $v2['payment_mode']): ?>
                                                ...
                                                <td class="" style=" width:13%;">
                                                    <div class="skin-list1">
                                                    <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                            <p class="">从<?php echo $v2['start_loadingtime']; ?>
                                                                </br>到<?php echo $v2['end_loadingtime']; ?> 
                                                            </p>
                                                        <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </div>
                                                </td>
                                                <td class="" style="width: 9%">
                                                    <div class="skin-list1">
                                                        <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                <p class="ellipsis"><?php echo $v2['contact']; ?></br><?php echo $v2['phone']; ?></p>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="skin-list1">
                                                        <p class="">
                                                            ...
                                                            <?php elseif($vo['car_state'] == '3'): ?>
                                                                运输中               
                                                            <?php elseif($vo['car_state'] == '4'): if($vo['order_state'] == '3'): ?>
                                                                    交易完成<br/>等待平台支付
                                                ...
                                                <?php if($vo['car_state'] == '1'): ?>
                                                    <td class="" style="width: 10%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Personalcenterorder/order_carfindgoods_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                ...
                                                <?php elseif($vo['car_state'] == '2'): ?>
                                                    <td class="" style="width: 10%">
                                                        <div class="zc-positon"> 
                                                            ...
                                                            <a href="<?php echo url('Personalcenterorder/depart',array('id'=>$vo['id'])); ?>" class="btn1" title="发车" onClick="return confirm('确定您已发车吗？')" datatype="1"><span class="fa fa-truck"></span></a>
                                                        </div>
                                                    </td>
                                                <?php elseif($vo['car_state'] == '3'): ?>
                                                    <td class="" style="width: 10%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Personalcenterorder/order_carfindgoods_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Personalcenterorder/finish',array('id'=>$vo['id'])); ?>" class="btn1" title="确认订单完成" onClick="return confirm('确定此订单货物已送达了吗？')" datatype="1"><span class="glyphicon glyphicon-ok-circle"></span></a>
                                                        </div>
                                                    </td>
                                                <?php elseif($vo['car_state'] == '4'): ?>
                                                    <td class="" style="width: 10%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Personalcenterorder/order_carfindgoods_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Personalcenterorder/car_del',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                        </div>
                                                    </td>
                                                <?php else: ?>
                                                    <td class="" style="width: 10%">
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($order_goodscarres) != true): if($order_goodscarres->isEmpty()): else: ?>
                                            <?php echo $order_goodscarres->render(); ?>
                            ...
                            <!-- <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($order_goodscarres) != true): if($order_goodscarres->isEmpty()): else: ?>
                                            <?php echo $order_goodscarres->render(); endif; endif; ?>
                                </div>
                            </div> -->                           
                        </div>                        
                    </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/myorder_findgoodscar.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
