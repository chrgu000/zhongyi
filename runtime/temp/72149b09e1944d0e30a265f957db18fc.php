<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\WWW\zhongyi\public/../application/admin\view\index\index.html";i:1524724986;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
   ...
   <span class="Hui-subtitle l">V1.0</span>
	<ul class="Hui-userbar">
		...
		<!-- <li style="padding-right: 15px;">
	        <a href="http://42.228.11.187/chat/index.php/site_admin" target="_blank" style="color: #fff;
	         text-decoration: none;">客服登录</a>
	    </li> -->
	    <!-- <li style="padding-right: 15px;">
	        <a href="<?php echo url('Index/cachedel'); ?>" style="color: #fff;
	         text-decoration: none;">清除缓存</a>
	    </li> -->
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">个人中心&nbsp;<i class="fa fa-angle-down"></i></a>
			<ul class="dropDown-menu radius box-shadow">
				...
				<!-- <li><a href="<?php echo url('Index/cachedel'); ?>">清除缓存</a></li> -->
