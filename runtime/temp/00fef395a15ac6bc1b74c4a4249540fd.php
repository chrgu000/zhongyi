<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\WWW\zhongyi\public/../application/admin\view\feature\featurelst.html";i:1524294584;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 中医特色 
    <span class="c-gray en">&gt;</span> 特色内容列表 
    <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" 
    href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="pd-20 nullwrap">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	<form action="<?php echo url('Feature/p_del1'); ?>" method="post"> 
        <span class="l">
		...
		<tbody>
		   <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂无相关信息</p>" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td class="td-manage">
                    <a title="编辑"  href="<?php echo url('Feature/edit1',array('id'=>$v['id'])); ?>" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe6df;</i></a> 
                    <a title="删除" href="<?php echo url('Feature/del1',array('id'=>$v['id'])); ?>"  onclick="return confirm('确定要删除吗？')" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
			</tr>
