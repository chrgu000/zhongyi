<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\zhongyi\public/../application/admin\view\study\lst_file.html";i:1524478740;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20 nullwrap">
	<div class="text-c">
	<form action="<?php echo url('Study/lst_file'); ?>" method="get">
        <input type="text" class="input-text" style="width:250px" placeholder="请输入文件名关键字" id="" name="keywords">
		<button type="submit" class="btn btn-success">
		<i class="Hui-iconfont">&#xe665;</i> 查询</button>
	</form>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	<form action="<?php echo url('Study/p_del'); ?>" method="post">
        <span class="l">
	...
	<table class="table table-border table-bordered table-bg nulltable">
		<thead>
			<tr>
				<th scope="col" colspan="10">文件列表</th>
			</tr>
			<tr class="text-c">
		...
		<tbody>
		   <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂无相关信息</p>" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td class="td-manage">
                    <a title="下载"  href="<?php echo url('Study/download',array('id'=>$v['id'])); ?>" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe640;</i></a>
                    <a title="删除" href="<?php echo url('Study/del_file',array('id'=>$v['id'])); ?>"  onclick="return confirm('确定要删除吗？')" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
			</tr>
