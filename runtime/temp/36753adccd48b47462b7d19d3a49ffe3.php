...
<head>
    ...
    <style type="text/css">
        ...
        .goods_detail .entrust_rtext{
          width: 250px;
        }
        .goods_detail .entrust_sub{
          padding:10px 0px;
          text-align: center;
        }
        .goods_detail .entrust_sub input{
          background: #337cc9;
          color: #fff;
        }
        .goods_detail .remarkstyle{
          display: inline;
            ...
            <div id="m-infonavCont">
                <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
                    <div class="orderdetail">
                        <h3>
                          <span style="float: left;">订单修改</span>
                    ...
                    <form action="<?php echo url('Entrust/entrust_revise'); ?>" method="post">
                            ...
                            <tr>
                              ...
                              <td>
                                <ul class="u-inforUl detail">
                                    ...
                                    <li class="clearfix"><a>订单总金额：</a><span><input type="text" name="order_money" value="<?php echo $order['order_money']; ?>" class="entrust_rtext money_revise" /></span></li>
                                    ...
                                    <li class="clearfix"><a>备注：</a><span><textarea name="remark" readonly="" style="width: 250px; vertical-align: top;"><?php echo $vo['remark']; ?></textarea></span>
                                      <a class="u-aNext u-aNext1 remarkstyle" href="javascript:;" onclick="admin_add('修改备注','<?php echo url('Entrust/remarkrevise',array('id'=>$vo['id'],'id2'=>$order['id'])); ?>','600','300')" style="color: #fff;">修改</a>
                                      </li>
                                </ul>
                              </td>
                              <td>
                      ...
                      <div class="entrust_sub">
                        <input type="submit" name="" value="提交" style="width: 300px;">
                      </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('.money_revise').change(function(){
      $('.money_revise').val($(this).val());
    });
