<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\WWW\transport\public/../application/index\view\aboutus\honor.html";i:1508720985;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
        ...
        <div class="container-flued higo-main-content" style="padding:0px;">
            ...
            <div class="zy_gywm">
                <div class="ejdh">
                    ...
                    <div class="zy_dh_lb">
                        <ul>
                            ...
                            <li class="active"><a href="<?php echo url('Aboutus/honor'); ?>"><span class="glyphicon glyphicon-play"></span>&nbsp;荣誉资质</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="zynr_db">
                    <div class="lujing">
                        <!-- <h2>荣誉资质</h2> -->
                        <p style="float: left;"><span class="glyphicon glyphicon-home"></span>&nbsp;您的位置：<a href="<?php echo url('Index/index'); ?>">首页</a> > <a href="<?php echo url('Aboutus/aboutus'); ?>">关于我们</a> > <a href="<?php echo url('Aboutus/honor'); ?>">荣誉资质</a></p>
                    </div>
                    ...
                    <div class="gsjj_nr">
                        <ul class="anlizs_lb">
                            <?php if(is_array($honorres) || $honorres instanceof \think\Collection || $honorres instanceof \think\Paginator): $i = 0; $__LIST__ = $honorres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <li class="ryzzli">
                                    <div class="anlz_tp_z">
                                        <div class="anlz_tp"><img class="img" src="__IMG__<?php echo $v['imgurl']; ?>"></div>
                                        <!-- <div class="anlz_fg">
                                    ...
                                    <p class="anlibt" href=""><?php echo $v['title']; ?></p>
                                </li>
