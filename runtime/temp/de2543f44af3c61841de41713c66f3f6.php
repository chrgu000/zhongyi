<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"E:\WWW\transport\public/../application/index\view\personalcenter\check_message.html";i:1511159775;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="personCenter">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <!-- 右侧开始 -->
        <?php if($userres['type'] == '车主'): ?>
            <!-- 个体司机认证信息 -->
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                    <p class="p1 active">个体司机认证信息</p>
                </div>
                <div class="jg">尊敬的用户您好！您的个体司机身份已通过平台审核认证！</div>
                    ...
                    <div class="g-content g-content0">
                        <ul>
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">用户账号：</p>
                                <div class="mj-inptext fl">
                                    <!-- <input name="username" id="usercode" type="hidden"  placeholder="" autocomplete="off"> -->
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">真实姓名：</p>
                                <!--<input type="text" class="bigInput fl" />-->
                                <div class="mj-inptext fl">
                                    <!-- <input name="real_name" id="companyName" type="text" placeholder="" autocomplete="off"> -->
                                    <p class="fl add-p "><?php echo $userres['real_name']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">身份证号：</p>
                                <!--<input type="text" class="bigInput fl" />-->
                                <div class="mj-inptext fl">
                                    <!-- <input name="identity_id" id="companyName" type="text" placeholder="" autocomplete="off"> -->
                                    <p class="fl add-p "><?php echo $userres['identity_id']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">车牌号：&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                <!--<input type="text" class="bigInput fl" />-->
                                <div class="mj-inptext fl">
                                    <!-- <input name="car_id" id="companyName" type="text" placeholder="" autocomplete="off"> -->
                                    <p class="fl add-p "><?php echo $userres['car_id']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">行驶证：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        <img src="__IMG__<?php echo $userres['driver_card']; ?>" id="show">
                                    </div>
        ...
        <?php elseif($userres['type'] == '物流公司'): ?>
            ...
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                    <p class="p1 active">物流公司认证信息</p>
                </div>
                <div class="jg">尊敬的用户您好！您的物流公司身份已通过平台审核认证！</div>
                <form action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="type" value="物流公司">
                    <div class="g-content g-content0">
                        <ul>
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">用户账号：</p>
                                <div class="mj-inptext fl">
                                    <!-- <input name="username" id="usercode" type="hidden" value="<?php echo session('username')?>" placeholder="" autocomplete="off"> -->
                                    <p class="fl add-p "><?php echo session('username')?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">公司名称：</p>
                                <!--<input type="text" class="bigInput fl" />-->
                                <div class="mj-inptext fl">
                                    <!-- <input name="company_name" id="companyName" type="text" placeholder="" autocomplete="off"> -->
                                    <p class="fl add-p "><?php echo $userres['company_name']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">营业执照：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        <!-- <img src="__PUBLIC__/images/sci.png" id='show'> -->
                                        <img src="__IMG__<?php echo $userres['business_card']; ?>" id="show">
                                    </div>
                                    <!-- <span class="fileinput-button">
                                        <span>点击上传</span>
                                        <input type="file" name="business_card" id='file'; onchange="c()" class="sfz"  placeholder="请上传营业执照">
                                    </span> -->
                                </div>
                            </li>
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">道路运输许可证：</p>
                                <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        <!-- <img src="__PUBLIC__/images/sci.png" id='show1' > -->
                                        <img src="__IMG__<?php echo $userres['road_permit']; ?>" id="show">
                                    </div>
                                    <!-- <span class="fileinput-button">
                                        <span>点击上传</span>
                                        <input type="file" name="road_permit" id='file1'; onchange="c1()" class="sfz"  placeholder="请上传道路运输许可证">
                                    </span> -->
                                </div>
                            </li>
                        </ul>
        ...
        <?php elseif($userres['type'] == '库主'): ?>
            ...
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                    <p class="p1 active">库主认证信息</p>
                </div>
                <div class="jg">尊敬的用户您好！您的库主身份已通过平台审核认证！</div>
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="type" value="库主">
                    <div class="g-content g-content0">
                        <ul>
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">用户账号：</p>
        ...
        <?php elseif($userres['type'] == '个体货主'): ?>
            <!-- 个体货主认证信息 -->
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                    <p class="p1 active">个体货主认证信息</p>
                </div>
                <div class="jg">尊敬的用户您好！您的个体货主身份已通过平台审核认证！</div>
                <form action="<?php echo url('Personalcenter/shipperauth'); ?>" method="post" enctype="multipart/form-data" class="form1">
                <input type="hidden" name="type" value="个体货主">
                    <div class="g-content g-content0">
                        <ul>
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <input type="hidden" name="type_id" id="type" autocomplete="off">
                                <p class="fl add-p ">用户账号：</p>
                                <div class="mj-inptext fl">
                                    <!-- <input name="username" id="usercode" type="hidden" value="<?php echo session('username')?>" placeholder="" autocomplete="off"> -->
                                    <p class="fl add-p "><?php echo session('username')?></p>
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">个体经营许可证：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        <!-- <img src="__PUBLIC__/images/sci.png" id="show"> -->
                                        <img src="__IMG__<?php echo $userres['peison_business']; ?>" id="show">
                                    </div>
                                   <!--  <span class="fileinput-button">
                                        <span>点击上传</span>
                                        <input type="file" name="peison_business" id="file" ;="" onchange="c()" class="sfz" placeholder="请上传个体经营许可证">
                                    </span> -->
                                </div>
                            </li>
                        </ul>
        ...
        <?php else: ?>
            ...
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                    <p class="p1 active">公司货主认证信息</p>
                </div>
                <div class="jg">尊敬的用户您好！您的公司货主身份已通过平台审核认证！</div>
                    <div class="g-content g-content0">
                        <ul>
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                <p class="fl add-p ">用户账号：</p>
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">营业执照：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    ...
                                    <!-- <span class="fileinput-button">
                                        <span>点击上传</span>
                                        <input type="file" name="business_card" id="file1" ;="" onchange="c1()" class="sfz" placeholder="请上传营业执照">
                                    </span> -->
                                </div>
                            </li>
                        </ul>
