             ...
             <input type="hidden" name="is_recycle" value="0">
                <div class="rz-Form" style="margin-left: 200px;">
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <input onblur="mzReg(this)" name="wh_contact" id="idCard" class="sfz" type="text" placeholder="请输入发货人名称">
                        <label>请输入联系人</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
...
<script type="text/javascript">
    ...
    $('.person-left dl').eq(4).find('.hideleft').find('dd').eq(0).addClass('active'); 
</script>
</body>
</html>