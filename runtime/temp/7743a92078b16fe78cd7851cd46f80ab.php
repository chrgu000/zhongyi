<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"E:\wamp\www\transport\public/../application/admin\view\orderwarehouse\order-detail.html";i:1505889737;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
      ...
      <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
        ...
        <div class="orderdetail">
          <h3>
            ...
            <a class="back" href="<?php echo url('Orderwarehouse/lst'); ?>" style="color:#fff; text-decoration: none;">返回</a>
