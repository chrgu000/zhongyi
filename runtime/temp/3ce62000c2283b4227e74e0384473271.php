            ...
            <div class="orderdetail">
              ...
              <p>
                ...
                <span style="float: right;">订单状态：
                  <?php if($v1['order_state'] == '1'): ?>
                    待支付
                    <?php elseif($v1['order_state'] == '2'): ?>
                      已支付，等待对方确认货物入库
                    <?php elseif($v1['order_state'] == '3'): ?>
                      货物已入库，订单交易完成
                    <?php elseif($v1['order_state'] == '4'): ?>
                      交易取消
                    <?php else: ?>
                      交易取消，退款中
                  <?php endif; ?>
