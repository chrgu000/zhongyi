<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"E:\WWW\transport\public/../application/index\view\personalcenter\path_detail.html";i:1511162188;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                                    ...
                                    <td>
                                        <ul class="u-inforUl detail">
                                            ...
                                            <li class="clearfix"><a>目的地：</a>
                                                <span>
                                                    <?php echo $path['endsite']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>常用车型：</a>
                                                <span>
                                                    <?php echo $path['vehicle_type']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>常用车长：</a>
                                                <span>
                                                    <?php echo $path['vehicle_length']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>发布时间：</a>
                                                <span>
                                                    <?php echo $path['time']; ?>
                                                </span>
                                            </li>   
                                    ...
                                    <td>
                                        <ul class="u-inforUl detail">
                                            <li class="clearfix"><a>联系人： </a>
                                                <span><?php echo $path['linkman']; ?></span>
                                            </li>
                                            <li class="clearfix">
                                                <a>联系方式： </a>
                                                <span id="phone">
