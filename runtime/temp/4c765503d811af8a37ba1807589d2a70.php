<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\WWW\zhongyi\public/../application/admin\view\feature\add_feature.html";i:1525856343;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Feature/add_feature'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
		<div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>特色描述：</label>
            <div class="formControls col-8">
                <textarea name="text" class="textarea"  placeholder="请输入特色描述的基本内容..." nullmsg="描述不能为空！" onKeyUp="textarealength(this,300)"></textarea>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>特色图片：</label>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>特色内容：</label>
			<div class="formControls col-8"> 
