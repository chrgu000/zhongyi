<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"E:\WWW\transport\public/../application/index\view\personalcenterorder\acceptorder_wh.html";i:1511166821;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <?php if($userres['type'] == '物流公司'): ?>
                    ...
                    <a href="<?php echo url('Personalcenterorder/acceptorder_wh'); ?>"><p class="p4 active">库主抢单</p></a>
                <?php elseif($userres['type'] == '车主'): ?>
                    <a href="<?php echo url('Personalcenterorder/acceptorder_goodscar'); ?>"><p class="p1">货找车订单</p></a>
                <?php elseif($userres['type'] == '库主'): ?>
                    <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku'); ?>"><p class="p2">货找库订单</p></a>
            ...
            <div class="m-infortabBack">
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenterorder/acceptorder_wh'); ?>" method="get" class="searchform">
                                ...
                                <div class="clearfix fl m30">
                                    ...
                                    <div class="fr">
                                        <select name="order_state" class="siteselect" style="width: 150px;">
                                            <option >不限</option>
                                            <option value="1" <?php if($order_state == '1'): ?> selected="selected"<?php endif; ?> >待支付</option>
                                            <option value="2" <?php if($order_state == '2'): ?> selected="selected"<?php endif; ?> >已支付</option>
                                            <option value="3" <?php if($order_state == '3'): ?> selected="selected"<?php endif; ?> >已完成</option>
                                            <option value="4" <?php if($order_state == '4'): ?> selected="selected"<?php endif; ?> >已取消</option>
                                            <option value="5" <?php if($order_state == '5'): ?> selected="selected"<?php endif; ?> >退款中</option>
                                        </select>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">
                            <table style="min-width:960px;">
                                <tbody>
                                    ...
                                    <?php if(empty($goodsres) != true): if(is_array($order_goodsku1) || $order_goodsku1 instanceof \think\Collection || $order_goodsku1 instanceof \think\Paginator): $i = 0; $__LIST__ = $order_goodsku1;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                      
                                            <tr class="ky-ddKK ky-ddKK1 odd">
                                                <td class="zc-lastTr " style="width:15%;">
                                                    ...
                                                    <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                            <p class="ellipsis" title=" <?php echo $v2['whaddress']; ?>"  style="text-align:left;"><?php echo $v2['whaddress']; ?></p>
                                                ...
                                                <td class="" style="width:20%;">
                                                    <div class="skin-list1">
                                                        <div class="czh-posi">
                                                        <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                <p><?php echo $v2['goods_name']; ?></br><?php echo $v2['standard_ton']; ?>吨，<?php echo $v2['standard_square']; ?>方 </p>
                                                            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="" style="width: 15%">
                                                    <div class="skin-list1">
                                                         <p class=""><?php echo $vo['order_contact']; ?></br><?php echo $vo['order_phone']; ?></p>
                                                    </div>
                                                </td>
                                                ...
                                                <?php if($vo['pay_state'] == '1'): ?>
                                                    <td class="" style="width: 6%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Personalcenterorder/order_kufindgoods_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="md-content">
                                                                    <h3>在线支付</h3>
                                                                        ...
                                                                        <ul class="order_ku fl" style="margin-left: 60px;">
                                                                        <form action="<?php echo url('Personalcenterorder/alipay1'); ?>" method="post" class="rz-Form">
                                                                            ...
                                                                            <button type="submit" class=" alipy fl"  style="background: none;">
                                                                            <img class="payicon" src="__PUBLIC__/images/alipay.jpg">
                                                                            <span >支付宝</span></button>
                                                                        </form>
                                                                        </ul>
                                                                    
                                                                        <ul class="order_ku fr" style="margin-right: 60px;">
                                                                        <!-- <form action="<?php echo url('Personalcenterorder/weixin',array('id'=>$vo['id'])); ?>" method="post" class="rz-Form">
                                                                            <input type="hidden" name="order_number" value="<?php echo $vo['order_number']; ?>">
                                                                            <input type="hidden" name="id" value="<?php echo $vo['id']; ?>">
                                                                            <input type="hidden" name="order_money" value="<?php echo $vo['order_money']; ?>">
                                                                            <input type="hidden" class="form-control" name="attach" value="账户余额充值">
                                                                            <input type="hidden" class="form-control" name="body" value="在线充值金额到账户余额">
                                                                            <button type="submit" class=" alipy fl"  style="background: none;">
                                                                            <img class="payicon" src="__PUBLIC__/images/weixin.jpg" ><span>微信</span>
                                                                        </form> -->
                                                ...
                                                <?php elseif($vo['pay_state'] == '2'): ?>
                                                    <td class="" style="width: 6%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Personalcenterorder/order_kufindgoods_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Personalcenterorder/goodsfinish1',array('id'=>$vo['id'])); ?>" class="btn1" title="确定入库" datatype="1" onClick="return confirm('确定货物已经入库吗？')"><span class="glyphicon glyphicon-home"></span></a>
                                                ...
                                                <?php elseif($vo['pay_state'] == '3'): ?>
                                                    <td class="" style="width: 6%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Personalcenterorder/order_kufindgoods_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Personalcenterorder/goods_del1',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                        </div>
                                                    </td>
                                                <?php elseif($vo['pay_state'] == '4'): ?>
                                                    <td class="" style="width: 6%">
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($goodsres) != true): if($order_goodsku1->isEmpty()): else: ?>
                                            <?php echo $order_goodsku1->render(); ?>
                            ...
                            <!-- <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($goodsres) != true): if($order_goodsku1->isEmpty()): else: ?>
                                            <?php echo $order_goodsku1->render(); endif; endif; ?>
                                </div>
                            </div>  -->
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/acceptorder_wh.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
