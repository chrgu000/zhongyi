<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\WWW\zhongyi\public/../application/admin\view\study\edit_article.html";i:1525660957;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	...
	<input type="hidden" name="id" value="<?php echo $list['id']; ?>">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>小百科名称：</label>
		...
		<div class="row cl">
			<label class="form-label col-2">小百科简介：</label>
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				...
				<a class="btn btn-primary radius" href="<?php echo url('Study/lst_article'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>
