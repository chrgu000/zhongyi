<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\WWW\transport\public/../application/index\view\entrust\order-detail.html";i:1508763185;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                          ...
                          <td>
                            <ul class="u-inforUl detail">
                                <li class="clearfix"><a>始发地：</a><span>
                                  <?php echo $order['startsite']; ?><?php echo $order['startsite_detail']; ?>
                                </span></li>
                                <li class="clearfix"><a>目的地： </a><span>
                                  <?php echo $order['endsite']; ?><?php echo $order['endsite_detail']; ?>
                                </span></li>
                                <li class="clearfix"><a>装车时间：</a><span>
                                  <?php echo $order['start_loadingtime']; ?>——<?php echo $order['end_loadingtime']; ?>
                                </span></li>
                                <li class="clearfix"><a>到货时间：</a><span>
                                  <?php echo $order['start_arrivetime']; ?>——<?php echo $order['end_arrivetime']; ?>
                                </span></li>
                                <li class="clearfix"><a>需要车型：</a><span>
                                   <?php if(is_array($car_type2) || $car_type2 instanceof \think\Collection || $car_type2 instanceof \think\Paginator): $i = 0; $__LIST__ = $car_type2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['id'] == $order['car_type']): ?>
                                        <?php echo $v['typename']; endif; endforeach; endif; else: echo "" ;endif; ?>
                                </span></li>
                                <li class="clearfix"><a>需要车长：</a><span>
                                  <?php if(is_array($car_length2) || $car_length2 instanceof \think\Collection || $car_length2 instanceof \think\Paginator): $i = 0; $__LIST__ = $car_length2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['id'] == $order['car_length']): ?>
                                      <?php echo $v['typename']; endif; endforeach; endif; else: echo "" ;endif; ?>
                                </span></li>
                                <li class="clearfix"><a>订单金额：</a><span><?php echo $order['order_money']; ?></span></li>
                                <li class="clearfix"><a>支付方式：</a><span>
                                   <?php if(is_array($payment_mode2) || $payment_mode2 instanceof \think\Collection || $payment_mode2 instanceof \think\Paginator): $i = 0; $__LIST__ = $payment_mode2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['id'] == $order['payment_mode']): ?>
                                        <?php echo $v['typename']; endif; endforeach; endif; else: echo "" ;endif; ?>
                                </span></li>
                                <li class="clearfix"><a>是否需要发票：</a><span><?php echo $order['invoice']; ?></span></li>
                            </ul>
                          </td>
                          <td>
                            <ul class="u-inforUl detail">
                             <li class="orderdetail_tit">承运方基本信息</li>
                              ...
                              <li class="orderdetail_tit">货主基本信息</li>
                              <li class="clearfix"><a>发货人姓名：</a><span><?php echo $order['shipper_name']; ?></span></li>
                              <li class="clearfix"><a>发货人联系电话： </a><span><?php echo $order['shipper_phone']; ?></span></li>
                              <li class="clearfix"><a>收货人姓名：</a><span><?php echo $order['receiver_name']; ?></span></li>
                              <li class="clearfix"><a>收货人联系电话： </a><span><?php echo $order['receiver_phone']; ?></span></li>
                            </ul>
                          </td>
                        </tr>
                      </tbody>
