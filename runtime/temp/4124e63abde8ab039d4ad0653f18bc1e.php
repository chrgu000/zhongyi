<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:101:"E:\WWW\transport\public/../application/index\view\personalcenterorder\order_carfindgoods_detail1.html";i:1509006535;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
          ...
          <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
            ...
            <div class="orderdetail">
              <h3>
                ...
                <a class="back" href="<?php echo url('Personalcenterorder/myorder_findgoodscar'); ?>">返回</a>
                <div class="clearfix"></div>
              </h3>
              ...
              <p>
                ...
                <span style="float: right;">订单状态：
                  <?php if($v1['car_state'] == '1'): ?>
                    订单待支付
                    <?php elseif($v1['car_state'] == '2'): ?>
                      订单已支付，等待发车
                    <?php elseif($v1['car_state'] == '3'): ?>
                      已发车，货物运输中
                    <?php elseif($v1['car_state'] == '4'): if($v1['order_state'] == '3'): ?>
                        交易完成，等待平台支付
                ...
                <tr>
                  <!-- 货主信息 -->
                    <td>
                      ...
                      <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v4): $mod = ($i % 2 );++$i;?>
                        <ul class="u-inforUl detail">
                          ...
                          <li class="clearfix"><a>订单金额：</a>
                            <span>
                              <?php echo $order_goodscarres['order_money']; ?>元
                            </span>
                          </li>
                      ...
                      <ul class="u-inforUl detail">
                        ...
                        <li class="clearfix"><a>承运方姓名：</a>
                          <span>
                            ...
                            <?php echo $v1['transporter_name']; ?>
                          </span>
                        </li>
                        <li class="clearfix"><a>承运方联系方式：</a><span><?php echo $v1['transporter_phone']; ?></span></li>
                        <li class="clearfix"><a>认证类型： </a>
                          <span>
                            <?php if(is_array($type_id) || $type_id instanceof \think\Collection || $type_id instanceof \think\Paginator): $i = 0; $__LIST__ = $type_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;if($vo3['id'] == $userres2['type_id']): ?>
                                <?php echo $vo3['typename']; endif; endforeach; endif; else: echo "" ;endif; ?>
                            &nbsp;
                            <?php if($userres2['type'] != ''): ?>
                              (<?php echo $userres2['type']; ?>)
                              <?php else: endif; ?>
                          </span>
                        </li>
                      </ul>
