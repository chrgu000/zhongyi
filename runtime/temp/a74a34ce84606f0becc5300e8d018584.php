<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"E:\WWW\transport\public/../application/index\view\personalcenter\logisticsauth.html";i:1509084565;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <p class="p1 active">物流公司认证</p>
            </div>
            <div class="jg">尊敬的用户！为了方便进行交易请您进行实名认证！打<span>*</span>为必填项</div>
            <form action="" method="post" enctype="multipart/form-data" onSubmit="return checklogisticsauth();">
            ...
            <input type="hidden" name="check_state" value="3">
                <div class="g-content g-content0">
                    <ul>
                        ...
                        <li class="u-start c-startEnd list clearfix">
                            <p class="fl add-p"><span>*</span>道路运输许可证：</p>
                            <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                <div class="img_show">
