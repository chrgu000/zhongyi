<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\WWW\zhongyi\public/../application/admin\view\feature\add.html";i:1524279205;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<title>新增特色描述内容</title>
</head>
<body>
<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" 
 href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
<div class="pd-20">
	<form action="<?php echo url('Feature/add'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
        <div class="row cl">
		...
		<div class="row cl">
            ...
            <div class="formControls col-8">
                <textarea name="text" class="textarea"  placeholder="请输入特色描述内容..." nullmsg="描述不能为空！" onKeyUp="textarealength(this,300)"></textarea>
            </div>
        </div>
		<!--<div class="row cl">
