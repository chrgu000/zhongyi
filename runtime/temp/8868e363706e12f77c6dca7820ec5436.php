<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\wamp\www\transport\public/../application/index\view\news\newsdetail.html";i:1505960524;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506071803;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>新闻资讯</title>
...
<div class="container-flued" style="background: #f5f5f5;">
    <div class="newsimage">
        <img src="__PUBLIC__/images/xwzx.jpg" >
        <p class="newstitle">新闻资讯</p>
    </div>
    <div class="nav clearfix wrap-1200" style="padding: 30px 0px; ">
    	<div class="newsdetail wrap-990 fl">
            <div class="newstit">
                <h3><?php echo $articleres['title']; ?></h3>
                <p><span><?php echo $articleres['articletime']; ?></span></p>
            </div>
            <div class="newscon">
                <p>
            ...
            <div class="">
                <?php if($pre['id'] != ''): ?>
                <a class="pre_next" href="<?php echo url('news/newsdetail',array('id'=>$pre['id'])); ?>"><p>上一篇&nbsp;&nbsp;<?php echo $pre['title']; ?></p></a>
                <?php endif; if($next['id'] != ''): ?>
                <a class="pre_next" href="<?php echo url('news/newsdetail',array('id'=>$next['id'])); ?>"><p>下一篇&nbsp;&nbsp;<?php echo $next['title']; ?></p></a>
                <?php endif; ?>
            </div>  
        </div>
        <div class="newshot fl">
            <div class="v-hd2" style="margin-bottom: 0px;">
                <span class="dot" ></span>
                <a href="" class="tit f-ff2 f-tdn">热点新闻</a>
            </div>
            <div class="goods_content">
                <div class="goods_r">
                    <ul class="newshot_list">
                        ...
                        <li>
                            <a href="<?php echo url('news/newsdetail',array('id'=>$vo['id'])); ?>">
                                <p class="fl"><?php echo $vo['title']; ?></p>
                                <p class="fr"><?php echo $vo['articletime']; ?></p>
                                <div class="clearfix"></div>
                            </a>
                        </li>
