<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"E:\WWW\transport\public/../application/index\view\entrust\myentrust.html";i:1510026963;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <p class="p1 active">我的托运</p>
            </div>
            <!-- 我的托运 -->
            <div class="m-infortabBack form1" >
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Entrust/myentrust'); ?>" method="get" class="searchform">
                            <div class="m-inforForm clearfix" style="margin-bottom: 5px;padding-top: 20px;">
                                <div class="clearfix fl m30">
                                    <p class="fl">订单状态：</p>
                                    <div class="fr">
                                        <select name="pay_state" class="siteselect" style="width: 150px;">
                                            <option >不限</option>
                                            <option value="1" <?php if($pay_state == '1'): ?> selected="selected"<?php endif; ?> >待确认</option>
                                            <option value="2" <?php if($pay_state == '2'): ?> selected="selected"<?php endif; ?> >待支付</option>
                                            <option value="3" <?php if($pay_state == '3'): ?> selected="selected"<?php endif; ?> >已支付，派车中</option>
                                            <option value="4" <?php if($pay_state == '4'): ?> selected="selected"<?php endif; ?> >已发车，运输中</option>
                                            <option value="5" <?php if($pay_state == '5'): ?> selected="selected"<?php endif; ?> >已完成</option>
                                            <option value="6" <?php if($pay_state == '6'): ?> selected="selected"<?php endif; ?> >交易取消</option>
                                            <option value="7" <?php if($pay_state == '7'): ?> selected="selected"<?php endif; ?> >退款中</option>
                                        </select>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active " style="padding-top: 10px;">
                                ...
                                <tbody>
                                    ...
                                    <?php if(empty($order) != true): if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            ...
                                            <tr class="ky-ddKK ky-ddKK1 even">
                                                ...
                                                <?php if($vo['pay_state'] == '1'): ?>
                                                    <td class="skin-border" style="width:7%;">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Entrust/myentrust_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Entrust/entrust_revise',array('id'=>$vo['id'])); ?>" class="btn1" title="修改" datatype="1"><span class="fa fa-pencil"></span></a>
                                                        ...
                                                        <div class="modal fade" id="<?php echo $vo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="md-content">
                                                                    ...
                                                                    <div>
                                                                        <ul class="order_ku">
                                                                        <form action="<?php echo url('Personalcenterorder/entrust_alipay'); ?>" method="post" class="rz-Form">
                                                ...
                                                <?php elseif($vo['pay_state'] == '4'): ?>
                                                    <td class="" style="width: 7%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Entrust/myentrust_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Entrust/finish2',array('id'=>$vo['id'])); ?>" class="btn1" title="确认货物送达" datatype="1" onClick="return confirm('确认货物已送达目的吗吗？')"><span class="glyphicon glyphicon-saved"></span></a>
                                                        </div>
                                                    </td> 
                                                <?php elseif($vo['pay_state'] == '5'): ?>
                                                    <td class="" style="width: 7%">
                                                        <div class="zc-positon"> 
                                                            <a href="<?php echo url('Entrust/myentrust_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                            <a href="<?php echo url('Entrust/goods_del3',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                        </div>
                                                    </td> 
                                                <?php elseif($vo['pay_state'] == '6'): ?>
                                                    <td class="" style="width: 7%">
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        var pay_state=$("select[name='pay_state']").val();
        ...
        $(this).attr('href','/transport/public/index/entrust/myentrust.html?pay_state='+pay_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
