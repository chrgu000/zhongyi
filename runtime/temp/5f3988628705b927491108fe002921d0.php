<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"E:\WWW\transport\public/../application/index\view\entrust\myentrust_detail1.html";i:1509528900;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1508989819;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
                    <div class="orderdetail">
                        <h3>
                          ...
                          <a class="back" href="<?php echo url('Entrust/receive_entrust'); ?>">返回</a>
                          <div class="clearfix"></div>
                        </h3>
                        <p>
                            <span>订单编号:</span>&nbsp;<?php echo $order['order_number']; ?>
                            <span style="float: right;">订单状态：
                                <?php if($order['car_state'] == '1'): ?>
                                 待确认
                                <?php elseif($order['car_state'] == '2'): ?>
                                 派车中，待付款
                                <?php elseif($order['car_state'] == '3'): ?>
                                 已支付，派车中
                                <?php elseif($order['car_state'] == '4'): ?>
                                 已发车，运输中
                                <?php elseif($order['car_state'] == '5'): ?>
                                  订单完成
                                <?php else: ?>
                                  交易取消
                              <?php endif; ?>
