<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\WWW\zhongyi\public/../application/admin\view\login\login.html";i:1524725031;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<![endif]-->
<title>中医科普网站后台登录 </title>
</head>
<body>
<input type="hidden" id="TenantId" name="TenantId" value="" />
<div class="header" style="font-size: 22px; letter-spacing: 1px; line-height: 55px; color:#EEEEEE;">中医科普网站后台管理系统</div>
        ...
        <form class="form form-horizontal" action="<?php echo url('Login/login'); ?>" method="post"  id="form-admin-add">
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="" name="adminname" type="text" placeholder="登录名" class="input-text size-L" datatype="*1-50" nullmsg="登录名不能为空">
                </div>
...
<div class="footer">Copyright XXXX版权所有</div>
