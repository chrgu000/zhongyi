<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\WWW\zhongyi\public/../application/admin\view\photo\edit_xuewei.html";i:1525485324;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	...
	<input type="hidden" name="id" value="<?php echo $list['id']; ?>">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>穴位名称：</label>
			<div class="formControls col-4">
				<input type="text" name="name" class="input-text" value="<?php echo $list['name']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="名称不能为空" >
			</div>
			<div class="col-1"> </div>
		</div>
        <div class="row cl">
            <label class="form-label col-2">穴位图片：</label>
            <div class="formControls col-6">
                <?php if($list['image'] != ''): ?>
                    <div class="userimg"><img src="__IMG__<?php echo $list['image']; ?>" /></div>
                    <span class="btn-upload form-group">
                    <a href="<?php echo url('Photo/xuewei_edit',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>
                    <a href="<?php echo url('Photo/xuewei_del',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn" onclick="return confirm('确定要删除吗？')"><i class="Hui-iconfont">&#xe642;</i> 删除图片</a>
                    </span>
                <?php else: ?> 
                <span class="btn-upload form-group">
                    <a href="<?php echo url('Photo/xuewei_edit',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" name="user" class="input-text" value="<?php echo $list['user']; ?>" readonly="true" >
			</div>
		</div>
		<!--<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-2">穴位简介：</label>
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				...
				<a class="btn btn-primary radius" href="<?php echo url('Photo/lst_xuewei'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>
