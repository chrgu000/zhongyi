                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">                            
                            <table style="min-width:960px;" class="table1">
                                <tbody>
                                    ...
                                    <?php if($goodsres != ''): if(empty($order_warehouseres) != true): if(is_array($order_warehouseres) || $order_warehouseres instanceof \think\Collection || $order_warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_warehouseres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                     
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($order_warehouseres) != true): ?>
                                        <?php echo $order_warehouseres->render(); endif; ?>
                                </div>
                            </div>                            
                        </div>                        
                    </div>
