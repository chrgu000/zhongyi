<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:102:"E:\WWW\transport\public/../application/index\view\personalcenterorder\acceptorder_goodsku_detail1.html";i:1508926188;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
                    <div class="orderdetail">
                        <h3>
                          ...
                          <a class="back" href="<?php echo url('Personalcenterorder/myorder_findku'); ?>">返回</a>
                          <div class="clearfix"></div>
                        </h3>
                        <p>
                            <span>订单编号:<?php echo $order['order_number']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                            <span style="float: right;">订单状态：
                            <?php if($order['pay_state'] == '1'): ?>
                              订单待确认
                            <?php elseif($order['pay_state'] == '2'): ?>
                              订单已确认，待付款
                            <?php elseif($order['pay_state'] == '3'): ?>
                              已支付，等待货物入库
                            <?php elseif($order['pay_state'] == '4'): ?>
                                货物已入库，订单交易完成
                            <?php elseif($order['pay_state'] == '5'): ?>
                               订单交易取消
                            <?php else: ?>
                                订单交易取消，退款中
                            <?php endif; ?>
