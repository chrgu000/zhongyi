<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"E:\WWW\transport\public/../application/index\view\personalcenter\warehouse_detail.html";i:1508925511;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1509590134;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                                ...
                                <tr>
                                    <td>
                                        <ul class="u-inforUl detail">
                                            <li class="clearfix"><a>仓库名称：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_name']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>仓库类型：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_type']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>仓库价格：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_price']; if($warehouse['wh_price_type'] == '0'): ?>
                                                      元/天/托
                                            ...
                                            <li class="clearfix"><a>仓库面积：</a>
                                                ...
                                                常温：<?php echo $warehouse['normal_area']; ?>平方；<?php echo $warehouse['normal_volume']; ?>立方
                                                    <p style="margin-left: 94px;">冷藏：<?php echo $warehouse['coldstorage_area']; ?>平方；<?php echo $warehouse['coldstorage_volume']; ?>立方</p>
                                                    <p style="margin-left: 94px;">冷冻：<?php echo $warehouse['freeze_area']; ?>平方；<?php echo $warehouse['freeze_volume']; ?>立方</p>
                                                    <p style="margin-left: 94px;">急冻：<?php echo $warehouse['quickfreeze_area']; ?>平方；<?php echo $warehouse['quickfreeze_volume']; ?>立方</p>
                                                    <p style="margin-left: 94px;">深冷：<?php echo $warehouse['deepcold_area']; ?>平方；<?php echo $warehouse['deepcold_volume']; ?>立方</p>
                                                </span>
                                            </li>
                                            <!-- <li class="clearfix"><a>可用库容：</a>
                                                <span>
                                                    <?php echo $warehouse['useable_area']; ?>平方；<?php echo $warehouse['useable_volume']; ?>立方
                                                </span>
                                            </li> -->
                                            <li class="clearfix"><a>增值服务：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_service']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>是否需要发票：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_invoice']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>发布日期：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_time']; ?>
                                                </span>
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
                                        <ul class="u-inforUl detail">
                                            <li class="clearfix"><a>仓库实拍图：</a>
                                                <span>
                                                    <img src="__IMG__<?php echo $warehouse['wh_photo']; ?>" style="width: 200px;height: 200px" />
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>仓库地址：</a>
                                                <span>
                                                    <?php echo $warehouse['wh_address']; ?></br>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>仓库详细地址：</a>
                                                <span>
                                                    
                                                    <?php echo $warehouse['wh_address_detail']; ?>
                                                </span>
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
                                        <ul class="u-inforUl detail">
                                            <li class="clearfix"><a>联系人： </a>
                                                <span><?php echo $warehouse['wh_contact']; ?></span>
                                            </li>
                                            <li class="clearfix">
                                                <a>联系方式： </a>
                                                <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <span id="phone">
                                                        <?php if($vo['check_state'] == '1'): ?> 
                                                            <?php echo $warehouse['wh_phone']; else: ?>
                                                            认证通过后可见
                                                        <?php endif; ?>
                                                    </span>
