<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"E:\WWW\transport\public/../application/index\view\personalcenter\goods_ku_detail.html";i:1508925363;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1508989819;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509409917;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>货源详情（找库货源）</title>
                        ...
                        <table style="max-width: 970px; width: 100%">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <ul class="u-inforUl detail">
                                            ...
                                            <li class="clearfix"><a>所需冷库地址： </a>    
                                                <span>
                                                    <?php echo $goods['whaddress']; ?>
                                                </span>
                                            </li>
                                           <!--  <li class="clearfix"><a>所需冷库详细地址： </a>
                                                <span>  
                                                    <?php echo $goods['whaddress_detail']; ?>
                                                </span>
                                            </li> -->
                                            ...
                                            <li class="clearfix"><a>入库时间： </a>
                                                <span>
                                                    <?php echo $goods['enter_wh_time']; ?>
                                                </span>
                                            </li>
                                            ...
                                            <li class="clearfix"><a>包装类型： </a>
                                                <span>
                                                    <?php echo $goods['package_type']; ?>   
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>存储费用（不包含其他费用）： </a>
                                                <span>
                                                    <?php echo $goods['store_price']; ?>
                                                </span>
                                            </li>
                                            <li class="clearfix"><a>价格类型： </a>
                                                <span>
                                                    <?php echo $goods['price_type']; ?>
                                                </span>
                                            </li>
                                    ...
                                    <td>
                                        <ul class="u-inforUl detail">
                                            <li class="clearfix"><a>货物实拍图：</a>
                                                <span>
                                                    <img src="__IMG__<?php echo $goods['goods_photo']; ?>" style="width: 200px;height: 200px" />
                                                </span>
                                            </li>
