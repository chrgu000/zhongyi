<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\wamp\www\transport\public/../application/index\view\login\findpass.html";i:1507620522;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506762234;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="head clearfix" style="overflow: visible;">
	...
	<div class="contanier">
		<div class="mj-Reg wrap-1200">
			<h2 class="m-regH2"><a class="u-regH2a u-h2pass" href="javascript:;">忘记密码</a></h2>
			<div class="m-regForm m-password">
			<form action="<?php echo url('index/Login/findpwd'); ?>" method="post" class="sms-form">
				<div class="c-regfloor">
					<em class="c-spanRight hide"></em>
					<b class="c-spanRight1">*</b>
					<i class="glyphicon glyphicon-earphone"></i>&nbsp;
					<input name="username" class="u-input input-phone" id="phoneVidate" pagemark="findpwd" maxlength="11" type="text" placeholder="请输入账号" onblur="checkfindname()">
					<span id="usercheck" style="color:red; font-size: 12px; float: right;"></span>
					<p class="u-point hide">你输入的账号有误</p>
				</div>
				<div class="c-regfloor1 c-regTest">
					...
					<div class="u-inputBorder fl">
						...
						<input name="code" id="code"  class="u-input u-inputWidth u-dxinput" type="text" placeholder="短信验证" maxlength="6" onblur="checksmscode()">
					</div>
					<a class="c-testBtn fr" href="javascript:;" onclick="createcode()">获取验证码</a>
					<div class="clearfix"></div>
					<span id="checkcode" style="color:red; font-size: 12px; display: block;"></span>
				</div>
				<div class="c-regfloor1 c-regTest add-p">
					<div class="u-inputBorder fl">
						<i class="glyphicon glyphicon-picture"></i>&nbsp;
						<input name="codeimg" class="u-input u-inputWidth u-yzinput" id="capCode" type="text" placeholder="验证码">
					</div>
					<p class="u-point hide">图片验证码输入有误</p>
					<em class="c-spanRight hide"></em>
					<b class="c-spanRight1">*</b>
					<div class="fr c-regImg">
						<img id="captchaMobile" src="<?php echo captcha_src(); ?>" width="170" height="42" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" />
					</div>
				</div>
				<div class="c-regfloor">
					<em class="c-spanRight hide"></em>
					...
					<input name="password" class="u-input inputPass" type="password" id="setPassWord" placeholder="请输入新密码">
				...
				<div class="c-regfloor">
					...
					<b class="c-spanRight1">*</b>
					<i class="glyphicon glyphicon-lock"></i>&nbsp;
					<input name="repassword" class="u-input ag-password" type="password" id="setPassAgain" placeholder="再次输入新密码" disabled>
					<b class="disable-posi"></b>
					<p class="u-point hide">密码输入不一致</p>
				</div>

				<div class="c-formBtn">
					<input type="submit" class="u-inptBtn" id="forgetPwd" value="提交" />
				</div>	
			</form>
			</div>
		</div>
