<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\zhongyi\public/../application/admin\view\difficult\edit.html";i:1524627638;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Difficult/edit'); ?>" method="post" class="form form-horizontal" id="form-admin-add">
  <input type="hidden" name="id" value="<?php echo $list['id']; ?>">
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>疑难杂症名称：</label>
    ...
    <div class="row cl">
        ...
        <a class="btn btn-primary radius" href="<?php echo url('Difficult/lst'); ?>" >返回</a>
			</div>
		</div>
	</form>
</div>
