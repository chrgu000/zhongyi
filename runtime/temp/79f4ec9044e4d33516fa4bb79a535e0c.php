<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"E:\wamp\www\transport\public/../application/index\view\aboutus\cultural.html";i:1506496852;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506071803;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
        ...
        <div class="container-flued higo-main-content" style="padding:0px;">
            ...
            <div class="zy_gywm">
                <div class="ejdh">
                    ...
                    <div class="zy_dh_lb">
                        <ul>
                            ...
                            <li class="active"><a href="<?php echo url('Aboutus/cultural'); ?>"><span class="glyphicon glyphicon-play"></span>&nbsp;企业文化</a></li>
                ...
                <div class="zynr_db">
                    <div class="lujing">
                        <!-- <h2>企业文化</h2> -->
                        <p style="float: left;"><span class="glyphicon glyphicon-home"></span>&nbsp;您的位置：<a href="<?php echo url('Index/index'); ?>">首页</a> > <a href="<?php echo url('Aboutus/aboutus'); ?>">关于我们</a> > <a href="<?php echo url('Aboutus/cultural'); ?>">企业文化</a></p>
                    </div>
