<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\wamp\www\transport\public/../application/admin\view\user\user-check.html";i:1507534129;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('User/check'); ?>" method="post" class="form form-horizontal" id="form-admin-add">
		...
		<div class="row cl">
			<div class="col-9 col-offset-3">
				...
				<a class="btn btn-primary radius" href="<?php echo url('User/checklst'); ?>" ">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
			</div>
		</div>
	</form>
</div>
