                                        ...
                                        <tr class="ky-ddKK ky-ddKK1 even">
                                            ...
                                            <td class="" style="width:12%;">
                                                <div class="skin-list1">
                                                    <div class="czh-posi">
                                                        <p class=""><?php echo $vo['carriage_type']; ?>&nbsp;&nbsp;<?php echo $vo['carriage']; ?> </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="skin-border" style="width:10%;">
                                                <div class="zc-positon"> 
                                                    ...
                                                    <?php if($vo['order_state'] == '1'): ?>
                                                        ...
                                                        <a href="<?php echo url('Personalcenter/goodslist_car_del',array('id'=>$vo['id'])); ?>" title="删除" onClick="return confirm('确定要删除吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                    <?php else: ?>
