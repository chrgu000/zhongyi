<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\wamp\www\transport\public/../application/index\view\service\secondpack.html";i:1505960212;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506071803;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
﻿<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="ziye_bj" style="float: none;">
    <div class="ziye_tu">
        <img src="__PUBLIC__/images/ecbzbanner.jpg">
    </div>
</div>
<div class="webAgency_container webAgency_2" style="height: auto; padding-bottom: 30px;">
    <div class="webAgency_box">
        ...
        <p class="hope">主要提供软质塑料包装印刷、小型精品盒印刷、个性可变包装印刷 等服务。</p>
    </div>
</div>
<div class="content wrap-1200">
    <div class="sy">
        <div class="sy_con " style="clear:both;">
            <ul class="sy_ul second_ul">
                <li>
                    <img src="__PUBLIC__/images/rzsl.jpg">
                    <p>软质塑料包装印刷</p>
                </li>
                <li>
                    <img src="__PUBLIC__/images/jph.jpg">
                    <p>小型精品盒印刷</p>
                </li>
                <li>
                    <img src="__PUBLIC__/images/gxcy.jpg">
                    <p>个性可变包装印刷</p>
                </li>
            </ul>
        </div>
