                          ...
                          <td>
                            ...
                            <ul class="u-inforUl detail">
                             <li class="orderdetail_tit">配送信息</li>
                              ...
                              <li class="clearfix"><a>所需冷库详细地址： </a><span><?php echo $goods['whaddress_detail']; ?></span></li>
                              <li class="clearfix"><a>所需冷库温度： </a>
                                <span>
                                  <?php echo $goods['need_wh_temperature']; ?>℃
                                </span>
                              </li>
                            ...
                            <ul class="u-inforUl detail">
                             <li class="orderdetail_tit">联系信息</li>
                              <li class="clearfix"><a>发货人信息：</a><span><?php echo $goods['contact']; ?></span></li>
                              <li class="clearfix"><a>发货人电话：</a><span><?php echo $goods['phone']; ?></span></li>
