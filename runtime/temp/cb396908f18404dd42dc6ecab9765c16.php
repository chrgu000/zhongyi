<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\WWW\zhongyi\public/../application/admin\view\talk\detail.html";i:1524795970;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-admin-add">
	    <div class="row cl">
			<label class="form-label col-3">消息标题:</label>
			<div class="formControls col-5">
				<input name="title" type="text" class="input-text" value="<?php echo $list['title']; ?>" readonly="true">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-3">消息内容:</label>
			<div class="formControls col-5">
				<textarea name="content" class="textarea" dragonfly="true" readonly="true" onKeyUp="textarealength(this,300)"><?php echo $list['content']; ?></textarea>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-3"><h4>回复内容</h4></label>
			<div class="formControls col-5">
		...
		<?php if($list1): if(is_array($list1) || $list1 instanceof \think\Collection || $list1 instanceof \think\Paginator): $i = 0; $__LIST__ = $list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<div class="row cl">
					<label class="form-label col-3">
						<a title="删除此条回复内容" href="<?php echo url('Talk/del1',array('id'=>$vo['id'])); ?>"  onclick="return confirm('确定要删除此条回复内容吗？')" class="ml-5" 
