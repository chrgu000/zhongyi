<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"E:\WWW\transport\public/../application/index\view\personalcenter\path_revise.html";i:1513849919;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1517308120;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="personCenter">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            ...
            <form id="addCarGoodsResource" enctype="multipart/form-data" method="post" novalidate="novalidate" class="form1">
                ...
                <div class="rz-Form" style="margin-left: 200px;">
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                            <p class="fl rz-i">*</p>
                            <p class="fl">始发地：&nbsp;</p>
                            <p class="editinfo"><?php echo $path['startsite']; ?></p>
                        </div>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                            <p class="fl rz-i">*</p>
                            <p class="fl">目的地：&nbsp;</p>
                            <p class="editinfo"><?php echo $path['endsite']; ?></p>
                        </div>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <?php if(is_array($cartype) || $cartype instanceof \think\Collection || $cartype instanceof \think\Paginator): if( count($cartype)==0 ) : echo "" ;else: foreach($cartype as $key=>$v1): ?>
                            <div class="libraryarea">
                                <input type="checkbox" name="vehicle_type[]" value="<?php echo $v1['typename']; ?>" <?php if(in_array($v1['typename'],$vehicle_type)): ?> checked="checked"<?php endif; ?>>&nbsp;<?php echo $v1['typename']; ?>
                            </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>

                        <!-- <div class="libraryarea">
                            <input type="checkbox" name="vehicle_type[]" value="冷藏车" <?php for($i=0; $i<count($vehicle_type);$i++){ if($vehicle_type[$i]=='冷藏车') {echo "checked";} }?> >&nbsp;冷藏车
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="vehicle_type[]" value="平板" <?php for($i=0; $i<count($vehicle_type);$i++){ if($vehicle_type[$i]=='平板') {echo "checked";} }?> >&nbsp;平板
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="vehicle_type[]" value="常温箱式" <?php for($i=0; $i<count($vehicle_type);$i++){ if($vehicle_type[$i]=='常温箱式') {echo "checked";} }?> >&nbsp;常温箱式
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="vehicle_type[]" value="集装箱" <?php for($i=0; $i<count($vehicle_type);$i++){ if($vehicle_type[$i]=='集装箱') {echo "checked";} }?> >&nbsp;集装箱
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="vehicle_type[]" value="高栏" <?php for($i=0; $i<count($vehicle_type);$i++){ if($vehicle_type[$i]=='高栏') {echo "checked";} }?> >&nbsp;高栏
                        </div> -->
                        <label>请选择常用车型</label>
                    </div>
                     <div class="rz-model rz-label">
                        ...
                        <?php if(is_array($carlength) || $carlength instanceof \think\Collection || $carlength instanceof \think\Paginator): if( count($carlength)==0 ) : echo "" ;else: foreach($carlength as $key=>$vv): ?>
                            <div class="libraryarea">
                                <!-- <input type="checkbox" name="vehicle_length[]" value="4.2米以下" <?php for($i=0; $i<count($vehicle_length);$i++){ if($vehicle_length[$i]=='4.2米以下') {echo "checked";} }?> >&nbsp;4.2米以下 -->
                                <input type="checkbox" name="vehicle_length[]" value="<?php echo $vv['typename']; ?>" <?php if(in_array($vv['typename'],$vehicle_length)): ?> checked="checked"<?php endif; ?>>&nbsp;<?php echo $vv['typename']; ?>
                            </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <!-- <div class="libraryarea">
                            <input type="checkbox" name="vehicle_length[]" value="4.2米-7.2米" <?php for($i=0; $i<count($vehicle_length);$i++){ if($vehicle_length[$i]=='4.2米-7.2米') {echo "checked";} }?> >&nbsp;4.2米-7.2米
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="vehicle_length[]" value="7.2米-9.6米" <?php for($i=0; $i<count($vehicle_length);$i++){ if($vehicle_length[$i]=='7.2米-9.6米') {echo "checked";} }?> >&nbsp;7.2米-9.6米
                        </div>
                        <div class="libraryarea">
                            <input type="checkbox" name="vehicle_length[]" value="9.6米以上" <?php for($i=0; $i<count($vehicle_length);$i++){ if($vehicle_length[$i]=='9.6米以上') {echo "checked";} }?> >&nbsp;9.6米以上
                        </div> -->
                        <label>请选择常用车长</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                            <p class="fl rz-i">*</p>
                            <p class="fl">联系人：&nbsp;</p>
                            <p class="editinfo"><?php echo $path['linkman']; ?></p>
                        </div>
                        <label>请输入联系人</label>
                    </div>
                    <div class="rz-model rz-label">
                        ...
                        <input onblur="uxPhone(this)" name="linkphone" id="idCard" class="sfz" type="text" placeholder="请输入联系电话" value="<?php echo $path['linkphone']; ?>">
