<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"E:\wamp\www\transport\public/../application/index\view\goods\goods_kuorder.html";i:1506418033;}*/ ?>
﻿<!DOCTYPE html>
...
<input type="hidden" name="goods_id" value="<?php echo $id1; ?>">
	...
	<li>
		...
		<div class="order_r fl">
			...
			<p><span>仓库地址：</span><?php echo $v4['wh_address']; ?>&nbsp;&nbsp;<?php echo $v4['wh_address_detail']; ?></p>
