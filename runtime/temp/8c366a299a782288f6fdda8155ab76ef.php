                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">                            
                            <table style="min-width:960px;" class="table1">
                                <tbody>
                                    ...
                                    <?php if($goodsres != ''): if(empty($order_pathres) != true): if(is_array($order_pathres) || $order_pathres instanceof \think\Collection || $order_pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_pathres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                       
