<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\WWW\zhongyi\public/../application/admin\view\body\add.html";i:1524650687;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<title>新增体质测试结果</title>
</head>
<body>
<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" 
 href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
<div class="pd-20">
	<form action="<?php echo url('Body/add'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
        ...
        <div class="row cl">
            <label class="form-label col-2">体质测试结果标题：</label>
            <div class="formControls col-4">
                <input type="text" name="title" class="input-text" value="" placeholder="请输入体质测试结果标题">
            </div>
        </div>
		<div class="row cl">
