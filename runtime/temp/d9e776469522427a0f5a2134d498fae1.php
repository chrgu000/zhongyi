<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\wamp\www\transport\public/../application/index\view\foot\aboutplant.html";i:1506406005;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506071803;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>平台介绍</title>
    ...
    <div class="wrap-1200">
        ...
        <div class="locationBox">
            <div class="pages_style">
                <div class="locationBox_name"><i class="glyphicon glyphicon-map-marker"></i>&nbsp;您现在的位置：<a href="<?php echo url('Index/index'); ?>">首页</a>&gt;<a href="<?php echo url('Foot/aboutplant'); ?>">关于平台</a>&gt;<a href="<?php echo url('Foot/aboutplant'); ?>">平台介绍</a></div>
            </div>
        </div>
         <!--具体内容-->
        <div class="page_content clearfix " >
            <div class="page_Section">
                <div class="Section_list">
                    <div class="Section_title"><em style="font-size: 16px;" class="glyphicon glyphicon-home"></em>&nbsp;关于平台</div>
                    <ul class="list">
                        <li class="hover"><a href="<?php echo url('Foot/aboutplant'); ?>"><span class="fa fa-angle-left icon"></span>平台介绍</a></li>
                        <li><a href="<?php echo url('Foot/contactus'); ?>"><span class="fa fa-angle-left icon"></span>联系我们</a></li>
                    </ul>
                    <div class="Phone">
                        <ul class=" clearfix">
                            <li class="img"></li>
            ...
            <div class="page_detailed">
                <div class="page_Switchbox">
                    <div class="bd">
                        <h2 class="tit" style="text-align: center;">平台介绍</h2>
                        <div class="padd">
                             <p class="indent">易冷链是郑州国际陆港开发建设有限公司旗下冷链物流线上交易平台及综合信息服务平台。</p>
                        </div>
                       <div class="padd">
                            <p class="indentbold">面向全国</p>
                            <p class="indent">易冷链是面向全国冷链物流行业线上交易平台，背靠郑州国际陆港开发建设有限公司，以自有车源、库源为主，自主产权冷藏箱、三种可选择箱型（45RF冷藏箱、40RF冷藏箱、40RF双机冷藏箱），专业的现代化冷库，高度智能化自动化的温控仓储基地及先进的仓储设施等自有资源，为客户提供在线下单、冷链运输、配送、仓储一条完整服务链。</p>
                        </div>
                        <div class="padd">
                            <p class="indentbold">自营为主，辅以整合国内冷链物流行业资源</p>
                            <p class="indent">易冷链以电子商务和网络公共平台为依托，主以自营为主，辅以整合国内冷链物流行业资源，提供冷链信息发布、冷链物流资源交易、车库联网技术、物流在线支付、金融等服务，打造全面的冷链物流综合信息服务平台。</p>
                        </div>
                        <div class="padd">
                            <p class="indentbold">全新体验</p>
                            <p class="indent">易冷链能够实现人、车、货、库之间的实时连接，通过大数据、云计算智能分析，帮助不同类型客户，根据自身条件为其定制与升级冷链物流模式，提高服务效率，享受科技给冷链物流带来的新体验。
                            </p>
                        </div>
                    </div>
                </div>
