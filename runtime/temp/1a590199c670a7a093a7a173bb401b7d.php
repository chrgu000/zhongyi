<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"E:\WWW\transport\public/../application/index\view\personalcenter\goodslist_car.html";i:1510026151;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1517308120;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <a href="<?php echo url('Personalcenter/goodslist_car'); ?>"><p class="p1 active">找车货源</p></a>
                <a href="<?php echo url('Personalcenter/goodslist_ku'); ?>"><p class="p2">找库货源</p></a>
            </div>
            <!-- 找车货源 -->
            <div class="m-infortabBack form1" >
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenter/goodslist_car'); ?>" method="get" class="searchform">
                            ...
                            <div class="m-inforForm clearfix" style="margin-bottom: 20px;">
                                ...
                                <div class="fl m30 search_margin">
                                    <p class="fl">所需车长：</p>
                                    <div class="fr">
                                        <select name="car_length" class="siteselect"  style="width: 210px;"  >
                                            ...
                                            <?php if(is_array($car_length) || $car_length instanceof \think\Collection || $car_length instanceof \think\Paginator): $i = 0; $__LIST__ = $car_length;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v5): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $v5['id']; ?>" <?php if($car_length2 == $v5['id']): ?> selected="selected" <?php endif; ?>><?php echo $v5['typename']; ?></option>
                            ...
                            <div class="m-inforForm clearfix" style="margin-bottom: 20px;">
                                <div class="fl m30">
                                    <p class="fl">始&nbsp;发&nbsp;地&nbsp;：</p>
                                    <div class="fr ku">
                                        <input name="starting_address" id="name" class="xm siteinput" type="text" value="<?php echo !empty($starting_address)?$starting_address : '';; ?>" placeholder="请输入始发地" style="width: 210px;">
                                        <div class="xiala">
                                            <h1><span>确认</span></h1>
                                        </div>
                                    </div>
                                ...
                                <div class="fl m30">
                                    <p class="fl">目&nbsp;的&nbsp;地&nbsp;&nbsp;：</p>
                                    <div class="fr ku1">
                                        <input name="destination" id="name" class="xm siteinput" type="text" value="<?php echo !empty($destination)?$destination : '';; ?>"  placeholder="请输入目的地" style="width: 210px;">
                                        <div class="xiala1">
                                            <h1><span>确认</span></h1>
                                        </div>
                                    </div>
                                    ...
                                    <div class="fr">
                                        <select name="payment_mode" class="siteselect" style="width:210px;"  >
                                            ...
                                            <?php if(is_array($payment_mode) || $payment_mode instanceof \think\Collection || $payment_mode instanceof \think\Paginator): $i = 0; $__LIST__ = $payment_mode;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $v2['id']; ?>" <?php if($payment_mode2 == $v2['id']): ?> selected="selected" <?php endif; ?>><?php echo $v2['typename']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                    <div class="clearfix"></div>
                            ...
                            <div class="m-inforForm clearfix moreshow" style="margin-bottom: 20px;">
                                ...
                                <div class="fl m30 search_margin">
                                    <p class="fl">所需车型：&nbsp;&nbsp;</p>
                                    <div class="fr">
                                        <select name="car_type" class="siteselect"  style="width: 210px;"  >
                                            ...
                                            <?php if(is_array($car_type) || $car_type instanceof \think\Collection || $car_type instanceof \think\Paginator): $i = 0; $__LIST__ = $car_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                                <option value="<?php echo $v1['id']; ?>" <?php if($car_type2 == $v1['id']): ?> selected="selected" <?php endif; ?> ><?php echo $v1['typename']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                    <div class="clearfix"></div>
                                ...
                                <div class="fl m30 search_margin">
                                    <p class="fl">装车时间：</p>
                                    <div class="fr">
                                        <input onblur="mzReg(this)" name="start_loadingtime" class="xm siteinput ECalendar" type="text" placeholder="请选择装车时间" value="<?php echo !empty($start_loadingtime)?$start_loadingtime : '';; ?>" style="width: 210px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})">
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="m-inforForm moreshow" >
                                <div class="fl m30 search_margin">
                                    <p class="fl">发布时间：</p>
                                    <div class="fr">
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active " style="padding-top: 0px;">
                            <table style="min-width:960px;">
                                <tbody>
                                    ...
                                    <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr class="ky-ddKK ky-ddKK1 even">
                                            <td class="zc-lastTr " style="width:14%;" >
                                                <div class="skin-list0">
                                            ...
                                            <td class="" style="width:12%;">
                                                <div class="skin-list1">
                                                    <div class="czh-posi">
                                                        <p class=""><?php echo $vo['carriage']; ?>&nbsp;元 </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="" style="width:15%;">
                                                <div class="skin-list1">
                                                    <p class="">从<?php echo $vo['start_loadingtime']; ?></br>到<?php echo $vo['end_loadingtime']; ?> 
                                                    </p>
                                                </div>
                                            </td>
                                            ...
                                            <td class="skin-border" style="width:10%;">
                                                <div class="zc-positon"> 
                                                    <a href="<?php echo url('Personalcenter/goods_car_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="详情" datatype="1"><span class="glyphicon glyphicon-eye-open"></span></a>
                                                    <?php if($vo['order_state'] == '1'): ?>
                                                        <a href="<?php echo url('Personalcenter/goodslist_car_revise',array('id'=>$vo['id'])); ?>" class="btn1" title="修改" datatype="1"><span class="fa fa-pencil"></span></a> 
                                                        <a href="<?php echo url('Personalcenter/goodslist_car_del1',array('id'=>$vo['id'])); ?>" title="删除" onClick="return confirm('确定要删除吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                    <?php else: ?>
                                                        <a href="<?php echo url('Personalcenter/goodslist_car_del1',array('id'=>$vo['id'])); ?>" title="删除" onClick="return confirm('确定要删除吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                    <?php endif; ?> 
                                                </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        var car_length=$("select[name='car_length']").val();
        var starting_address=$("input[name='starting_address']").val();
        ...
        var car_type=$("select[name='car_type']").val();
        var start_loadingtime=$("input[name='start_loadingtime']").val();
        ...
        $(this).attr('href','/transport/public/index/personalcenter/goodslist_car.html?goods_name='+goods_name+'&car_length='+car_length+'&starting_address='+starting_address+'&destination='+destination+'&payment_mode='+payment_mode+'&standard_ton='+standard_ton+'&standard_square='+standard_square+'&car_type='+car_type+'&start_loadingtime='+start_loadingtime+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
