<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"E:\WWW\transport\public/../application/index\view\personalcenterorder\acceptorder_goodsku.html";i:1511165714;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <?php if($userres['type'] == '物流公司'): ?>
                    ...
                    <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku'); ?>"><p class="p2 active">货找库订单</p></a>
            ...
            <div class="m-infortabBack">
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenterorder/acceptorder_goodsku'); ?>" method="get" class="searchform">
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">
                                                ...
                                                <tr class="ky-ddKK ky-ddKK1 odd">
                                                    ...
                                                    <td class="" style="width:15%;">
                                                        <div class="skin-list3">
                                                            <div class="czh-posi">
                                                            <?php if(is_array($warehouseres) || $warehouseres instanceof \think\Collection || $warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $warehouseres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['wh_id'] == $v1['id']): ?>
                                                                    <p class="ellipsis" title="<?php echo $v1['wh_address']; ?>">&nbsp;<?php echo $v1['wh_address']; ?></p>
                                                                    <p class="ellipsis" title="<?php echo $v1['wh_address_detail']; ?>">&nbsp;<?php echo $v1['wh_address_detail']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="" style="width:17%;">
                                                        <div class="skin-list3">
                                                            <div class="czh-posi">
                                                            <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                    <p class="ellipsis" title="<?php echo $v2['whaddress']; ?>">&nbsp; <?php echo $v2['whaddress']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                                            ...
                                                            <p class="">
                                                               <?php if($vo['ku_state'] == '1'): ?>
                                                                ...
                                                                <?php elseif($vo['ku_state'] == '3'): ?>
                                                                    已支付</br>
                                                                    待入库 
                                                                <?php elseif($vo['ku_state'] == '4'): if($vo['order_state'] == '3'): ?>
                                                                        交易完成<br/>等待平台支付
                                                                    <?php elseif($vo['order_state'] == '4'): ?> 
                                                                        交易完成<br/>平台已支付
                                                                    <?php endif; elseif($vo['ku_state'] == '5'): ?>
                                                                    交易取消
                                                                <?php endif; ?>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <?php if($vo['ku_state'] == '1'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/kusure',array('id'=>$vo['id'])); ?>" class="btn1" title="确认接受订单吗" onClick="return confirm('确认要接受订单吗？')" datatype="1"><span class="glyphicon glyphicon-ok-circle"></span></a>
                                                    ...
                                                    <?php elseif($vo['ku_state'] == '3'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/inku',array('id'=>$vo['id'])); ?>" class="btn1" title="入库" datatype="1" onClick="return confirm('确定要入库吗？')"><span class="glyphicon glyphicon-home"></span></a>
                                                    ...
                                                    <?php elseif($vo['ku_state'] == '4'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/ku_del',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                            </div>
                                                        </td>
                                                    <?php elseif($vo['ku_state'] == '5'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/ku_del',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($warehouseres) != true): if($order_warehouseres->isEmpty()): else: ?>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/acceptorder_goodsku.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
