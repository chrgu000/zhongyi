<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"E:\WWW\transport\public/../application/index\view\personalcenter\pathadd.html";i:1513849779;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1517308120;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <?php endif; ?>
                <div class="rz-Form" style="margin-left: 200px;">
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <?php if(is_array($cartype) || $cartype instanceof \think\Collection || $cartype instanceof \think\Paginator): if( count($cartype)==0 ) : echo "" ;else: foreach($cartype as $key=>$vv): ?>
                            <div class="libraryarea">
                                <input type="checkbox" name="vehicle_type[]" value="<?php echo $vv['typename']; ?>">&nbsp;<?php echo $vv['typename']; ?>
                            </div>
                     ...
                     <div class="rz-model rz-label">
                        ...
                        <?php if(is_array($carlength) || $carlength instanceof \think\Collection || $carlength instanceof \think\Paginator): if( count($carlength)==0 ) : echo "" ;else: foreach($carlength as $key=>$vo): ?>
                            <div class="libraryarea">
                                <!-- <input type="checkbox" name="vehicle_length[]" value="4.2米以下">&nbsp;4.2米以下 -->
                                <input type="checkbox" name="vehicle_length[]" value="<?php echo $vo['typename']; ?>">&nbsp;<?php echo $vo['typename']; ?>
                            </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <!-- <div class="libraryarea">
