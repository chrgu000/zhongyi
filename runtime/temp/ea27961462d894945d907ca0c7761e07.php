<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp\www\transport\public/../application/admin\view\orderpath\order-detail.html";i:1506419172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
      ...
      <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
        ...
        <div class="orderdetail">
          <h3>
            ...
            <a class="back" href="<?php echo url('Orderpath/lst'); ?>" style="color:#fff; text-decoration: none;">返回</a>
            ...
            <!-- 货主信息 -->
              <td style="vertical-align: top;">
                ...
                <ul class="u-inforUl detail">
                  ...
                  <li class="clearfix"><a>始发地：</a><span><?php echo $goods[0]['starting_address']; ?><?php echo $goods[0]['startingaddress_detail']; ?></span></li>
                  <li class="clearfix"><a>目的地：</a><span><?php echo $goods[0]['destination']; ?><?php echo $goods[0]['destination_detail']; ?></span></li>
                </ul>
              ...
              <td>
                <ul class="u-inforUl detail">
                  <li class="orderdetail_tit">车主信息</li>
                  <li class="clearfix"><a>车主账号：</a><span><?php echo $path['uid']; ?></span></li>
                </ul>

                <ul class="u-inforUl detail">
                  <li class="orderdetail_tit">车源信息</li>
                  <li class="clearfix"><a>始发地：</a><span><?php echo $path['startsite']; ?></span></li>
                  <li class="clearfix"><a>目的地：</a><span><?php echo $path['endsite']; ?></span></li>
                  <li class="clearfix"><a>常用车型：</a><span><?php echo $path['vehicle_type']; ?></span></li>
                  <li class="clearfix"><a>常用车长：</a><span><?php echo $path['vehicle_length']; ?></span></li>
                  <li class="clearfix"><a>发布时间：</a><span><?php echo $path['time']; ?></span></li>
                  <li class="clearfix"><a>是否自营:</a>
                      <span>
                        <?php if($path['is_company'] == 0): ?>非自营
                        <?php elseif($path['is_company']): ?>自营
                        <?php endif; ?>
                      </span>
                    </li>
                </ul>
                ...
                <ul class="u-inforUl detail">
                  <li class="orderdetail_tit">联系信息</li>
                  <li class="clearfix"><a>联系人：</a><span><?php echo $path['linkman']; ?></span></li>
                  <li class="clearfix"><a>联系方式：</a><span><?php echo $path['linkphone']; ?></span></li>
                </ul>
              </td> 
