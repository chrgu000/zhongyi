<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\WWW\zhongyi\public/../application/admin\view\photo\add_xuewei.html";i:1525485409;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Photo/add_xuewei'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>穴位名称：</label>
			<div class="formControls col-4">
				<input type="text" name="name" class="input-text" value="" placeholder="" id="" datatype="*1-200" nullmsg="名称不能为空" >
			</div>
			<div class="col-1"> </div>
		</div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>穴位图片：</label>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>穴位介绍：</label>
