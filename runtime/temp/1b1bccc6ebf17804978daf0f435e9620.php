<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"E:\wamp\www\transport\public/../application/admin\view\user\roadimg-edit.html";i:1506419398;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('User/roadimg_edit'); ?>" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
