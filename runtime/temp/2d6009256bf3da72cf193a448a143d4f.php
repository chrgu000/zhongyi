<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\zhongyi\public/../application/admin\view\photo\edit_book.html";i:1524468341;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	...
	<input type="hidden" name="id" value="<?php echo $list['id']; ?>">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>古籍书名：</label>
        ...
        <div class="row cl">
            <label class="form-label col-2">古籍图片：</label>
            <div class="formControls col-6">
                <?php if($list['image'] != ''): ?>
                    <div class="userimg"><img src="__IMG__<?php echo $list['image']; ?>" /></div>
                    <span class="btn-upload form-group">
                    <a href="<?php echo url('Photo/book_edit',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>
                    <a href="<?php echo url('Photo/book_del',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn" onclick="return confirm('确定要删除吗？')"><i class="Hui-iconfont">&#xe642;</i> 删除图片</a>
                    </span>
                <?php else: ?> 
                <span class="btn-upload form-group">
                    <a href="<?php echo url('Photo/book_edit',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>
		...
		<div class="row cl">
			<label class="form-label col-2">古籍简介：</label>
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				...
				<a class="btn btn-primary radius" href="<?php echo url('Photo/lst_book'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>
