<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"E:\WWW\transport\public/../application/index\view\personalcenter\goodslist_ku_revise.html";i:1517454876;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1517308120;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>修改货源（找库货源）</title>
...
<div class="personCenter">
    ...
    <?php if($userres['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            ...
            <!-- 找库货源 -->
            <form id="addCarGoodsResource" enctype="multipart/form-data" method="post" novalidate="novalidate" class="form2" action="<?php echo url('Personalcenter/goodslist_ku_revise'); ?>">
                ...
                <div class="rz-Form" style="margin-left: 200px;">
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                            <p class="fl rz-i">*</p>
                            <p class="fl" style="width: 100px;">需要冷库地&nbsp;：</p>
                            <p class="editinfo"><?php echo $goods['whaddress']; ?></p>
                        </div>
                    </div>
                     <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <input  onblur="mzReg(this)" name="enter_wh_time" class="xm siteinput ECalendar" type="text" placeholder="请选择入库时间" style="width: 462px;" value="<?php echo $goods['enter_wh_time']; ?>" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})">
                        <label>请选择入库时间</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <select onblur="mzReg(this)" name="storage_time" class="siteselect" style="width: 462px;">
                            <option value="" selected>请选择</option>
                            <?php if(is_array($storage_time) || $storage_time instanceof \think\Collection || $storage_time instanceof \think\Paginator): $i = 0; $__LIST__ = $storage_time;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo4): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $vo4['id']; ?>" <?php if($vo4['id'] == $goods['storage_time']): ?> selected <?php endif; ?>><?php echo $vo4['typename']; ?></option>
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <option value="" selected>请选择</option>
                            <?php if(is_array($goods_type) || $goods_type instanceof \think\Collection || $goods_type instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo6): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $vo6['id']; ?>"  <?php if($vo6['id'] == $goods['goods_type']): ?> selected <?php endif; ?>><?php echo $vo6['typename']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <label>请选择货物类型</label>
                    </div>
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <input onblur="mzReg(this)" name="package_type" id="name" class="xm" type="text" placeholder="请输入包装类型" value="<?php echo $goods['package_type']; ?>">
                        <label>请输入包装类型</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <input onblur="xsReg(this)" name="store_price" id="name" class="xm" type="text" placeholder="请输入货物价格" value="<?php echo $goods['store_price']; ?>">
                        <label>请输入价格</label>
                    </div>
                    <div class="rz-model rz-label">
                        <div class="clearfix">
                        ...
                        <div class="libraryarea">
                            <input type="radio" name="price_type" checked value="一口价">&nbsp;一口价
                        </div>
                        <label>请选择价格类型</label>
                    </div>
                    <div class="rz-model rz-label">
                        ...
                        <div class="libraryarea">
                            <?php if(is_array($payment_mode) || $payment_mode instanceof \think\Collection || $payment_mode instanceof \think\Paginator): $i = 0; $__LIST__ = $payment_mode;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    ...
                    <div class="rz-model rz-label">
                        ...
                        <select onblur="mzReg(this)" name="need_wh_temperature" class="siteselect" style="width: 462px;">
                            <option value="" selected>请选择</option>
                            <?php if(is_array($need_wh_temperature) || $need_wh_temperature instanceof \think\Collection || $need_wh_temperature instanceof \think\Paginator): $i = 0; $__LIST__ = $need_wh_temperature;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo5): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $vo5['id']; ?>" <?php if($vo5['id'] == $goods['need_wh_temperature']): ?> selected <?php endif; ?>><?php echo $vo5['typename']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <label>请选择库存温度</label>
                    </div>
                    ...
                    <!-- <div class="clearfix rz-model">
                       ...
                       <div class="img_show">
                            <img src="__IMG__<?php echo $goods['goods_photo']; ?>" id='show'>
                        </div>
                        <span class="fileinput-button">
                            <span>点击上传</span>
                            <input onblur="imgreg(this)" type="file" name="goods_photo" id='file' onchange="c()" class="sfz"  placeholder="请上传货物图片" value="<?php echo $goods['goods_photo']; ?>">
                        </span>
                    </div> -->
                    <div class="rz-model rz-label">
                        <div class="clearfix">
