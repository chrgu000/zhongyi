    ...
    <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['check_state'] == '1'): ?>
        ...
        <div class="person-right fr">
            ...
            <div class="per-img">
                ...
                <div class="pers-left fl my-left">
                    ...
                    <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <p class="per-time">
                            上次登录时间：
                            <span><?php echo $vo['login_time']; ?></span>
                        </p>
            ...
            <div class="mj-personList">
                <!-- 未进行认证 -->
                <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['check_state'] == '0'): ?>
                    <ul class="clearfix">
                        <li class="fl">
                ...
                <?php elseif($vo['check_state'] == '1'): if($vo['is_company'] == '1'): ?>
                    ...
                    <?php endif; elseif($vo['check_state'] == '2'): ?>
                    <!-- 认证不通过 -->
