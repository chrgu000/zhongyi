<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\wamp\www\transport\public/../application/admin\view\orderpath\order-list.html";i:1506419177;}*/ ?>
﻿
<!DOCTYPE HTML>
<html>
<head>
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 车源
    <!--<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" 
    href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>-->
</nav>
<div class="pd-20 nullwrap">
<div class="text-c">
<form action="<?php echo url('Orderpath/lst'); ?>" method="get">
    订单状态：
...
<div class="cl pd-5 bg-1 bk-gray mt-20" style="margin-top: 25px;">
    <span class="l">
        <a class="btn btn-danger radius" href="<?php echo url('Orderpath/export',array('order_state'=>session('routeorder_state'),'order_number'=>session('routeorder_number'),'time'=>session('routeordertime'))); ?>" style="margin-right: 5px;">
	    <i class="Hui-iconfont">&#xe632;</i> 导出数据</a>
    </span>
	<form action="<?php echo url('Orderpath/p_del'); ?>" method="post"> 
	<?php if(in_array('158',$privilege)){ ?>
        <span class="l">
		...
		<tbody>
		   <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂无相关信息</p>" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td  class="td-manage">
				<?php if(in_array('159',$privilege)){ if($v['order_state'] == 7): ?>
				    <a title="退款" href="<?php echo url('Orderpath/back',array('id'=>$v['id'])); ?>" onclick="return confirm('确定同意退款？')"  class="ml-5" style="color: #333; text-decoration: none;">
                    确认退款&nbsp;</a><br/>
                <?php endif; } if(in_array('160',$privilege)){ if($v['order_state'] == 4): ?>
				    <a title="完成" href="<?php echo url('Orderpath/finish',array('id'=>$v['id'])); ?>" onclick="return confirm('确定完成订单？')"  class="ml-5" style="color: #333; text-decoration: none;">
                    确认支付</a><br/>
                <?php endif; } ?>
                    <a title="查看" href="<?php echo url('Orderpath/detail',array('id'=>$v['id'])); ?>"  class="ml-5" style="color: #333; text-decoration: none;">
                    详情&nbsp;|</a> 
                <?php if(in_array('157',$privilege)){ ?>
                    <a title="删除" href="<?php echo url('Orderpath/del',array('id'=>$v['id'])); ?>"  onclick="return confirm('确定要删除？')" class="ml-5" style="color: #333; text-decoration: none;">
                    删除</a><?php } ?>
                </td>
			</tr>
