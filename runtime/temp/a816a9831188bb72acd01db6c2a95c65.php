<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\WWW\transport\public/../application/admin\view\web\indeximg-add.html";i:1507716643;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  ...
  <form action="<?php echo url('Web/logoindexadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <div class="row cl" style="margin-top: 25px;">
      <label class="form-label col-3">网站LOGO：</label>
      <div class="formControls col-3"> 
          <span class="btn-upload form-group">
              <input class="input-text upload-url" type="text" name="logo" id="uploadfile-2" placeholder="点击上传图片">
              <a href="javascript:void();" class="btn btn-primary radius upload-btn">
              <i class="Hui-iconfont">&#xe642;</i></a>
