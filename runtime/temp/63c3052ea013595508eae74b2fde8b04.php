<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\zhongyi\public/../application/admin\view\study\lst_video.html";i:1524486393;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 学习园地 
...
<div class="pd-20 nullwrap">
	<div class="text-c">
	<form action="<?php echo url('Study/lst_video'); ?>" method="get">
        <input type="text" class="input-text" style="width:250px" placeholder="请输入视频名称关键字" id="" name="keywords">
		<button type="submit" class="btn btn-success">
		<i class="Hui-iconfont">&#xe665;</i> 查询</button>
	</form>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	<form action="<?php echo url('Study/p_del1'); ?>" method="post">
        <span class="l">
		...
		<tbody>
		   <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂无相关信息</p>" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				...
				<td class="td-manage">
                    <!-- <a title="查看"  href="<?php echo url('Study/preview',array('id'=>$v['id'])); ?>" class="ml-5" style="text-decoration:none"> -->
            		<a title="查看" href="javascript:;" onclick="admin_add('查看详情','<?php echo url('Study/detail',array('id'=>$v['id'])); ?>','1100','800')" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe665;</i></a>
                    <a title="删除" href="<?php echo url('Study/del_video',array('id'=>$v['id'])); ?>"  onclick="return confirm('确定要删除吗？')" class="ml-5" style="text-decoration:none">
                    <i class="Hui-iconfont">&#xe6e2;</i></a>
                </td>
			</tr>
