<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"E:\WWW\transport\public/../application/index\view\personalcenterorder\order_kufindgoods_detail1.html";i:1508925909;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508989788;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
          ...
          <div class="m-infonavContent2 mj-xlxx goods_detail" style="background: #fff">
            ...
            <div class="orderdetail">
              <h3>
                ...
                <a class="back" href="<?php echo url('Personalcenterorder/myorder_findgoodsku'); ?>">返回</a>
                <div class="clearfix"></div>
              </h3>
              <?php if(is_array($order_goodskures) || $order_goodskures instanceof \think\Collection || $order_goodskures instanceof \think\Paginator): $i = 0; $__LIST__ = $order_goodskures;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
              <p>
                <span>订单编号：&nbsp;<?php echo $v1['order_number']; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                <span style="float: right;">订单状态：
                  <?php if($v1['ku_state'] == '1'): ?>
                    订单待支付
                    <?php elseif($v1['ku_state'] == '2'): ?>
                      订单已支付，等待货物入库
                    <?php elseif($v1['ku_state'] == '3'): if($v1['order_state'] == '2'): ?>
                        货物已入库，订单交易完成，等待平台支付
                      <?php elseif($v1['order_state'] == '3'): ?> 
                        交易完成，平台已支付
                      <?php endif; else: ?>
                      订单交易取消
                  <?php endif; ?>
                      ...
                      <?php endforeach; endif; else: echo "" ;endif; if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v4): $mod = ($i % 2 );++$i;?>
                        <ul class="u-inforUl detail">
                          ...
                          <li class="clearfix"><a>订单金额：</a>
                            <span>
                              <?php echo $order_goodskures[0]['order_money']; ?>元
                            </span>
                          </li>
                        ...
                        <ul class="u-inforUl detail">
                          ...
                          <?php endif; ?>
                          <li class="clearfix"><a>入库时间：</a><span><?php echo $v4['enter_wh_time']; ?></span></li>
                          ...
                          <li class="clearfix"><a>所需冷库温度： </a>
                                <span>
                                  <?php if(is_array($goods_t) || $goods_t instanceof \think\Collection || $goods_t instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_t;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;if($vv['id'] == $v4['need_wh_temperature']): ?>
                  ...
                  <!-- 库主信息 -->
                    ...
                    <?php if(is_array($userres3) || $userres3 instanceof \think\Collection || $userres3 instanceof \think\Paginator): $i = 0; $__LIST__ = $userres3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                      <ul class="u-inforUl detail">
                        ...
                        <li class="clearfix"><a>联系方式：</a><span><?php echo $vo1['username']; ?></span></li>
                        <li class="clearfix"><a>认证类型： </a>
                          <span>
                      ...
                      <?php endforeach; endif; else: echo "" ;endif; if(is_array($whres) || $whres instanceof \think\Collection || $whres instanceof \think\Paginator): $i = 0; $__LIST__ = $whres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
                      <ul class="u-inforUl detail">
                        <li class="orderdetail_tit">库源详情</li>
                        
                        <li class="clearfix"><a>仓库名称：</a><span><?php echo $vo2['wh_name']; ?></span></li>
                        <li class="clearfix"><a>仓库类型：</a><span><?php echo $vo2['wh_type']; ?></span></li>
                        <li class="clearfix"><a>仓库价格：</a>
                          <span>
                            <?php echo $vo2['wh_price']; if($vo2['wh_price_type'] == '0'): ?>
                              元/天/托
                              <?php elseif($vo2['wh_price_type'] == '1'): ?>
                                元/天/平
                              <?php elseif($vo2['wh_price_type'] == '2'): ?>
                                元/天/吨
                              <?php elseif($vo2['wh_price_type'] == '3'): ?>
                                元/天/方
                            <?php endif; ?>
                          </span>
                        </li>
                        <li class="clearfix"><a>仓库面积：</a>
                          <span>
                            <?php if($vo2['normal_area'] != ''): ?>
                              常温：<?php echo $vo2['normal_area']; ?>平方；<?php echo $vo2['normal_volume']; ?>立方
                              <?php else: endif; ?>
                            <p style="margin-left: 94px;">
                            <?php if($vo2['coldstorage_area'] != ''): ?>    
                              冷藏：<?php echo $vo2['coldstorage_area']; ?>平方；<?php echo $vo2['coldstorage_volume']; ?>立方
                              <?php else: endif; ?>
                            </p>
                            <p style="margin-left: 94px;">
                              <?php if($vo2['freeze_area'] != ''): ?>
                                冷冻：<?php echo $vo2['freeze_area']; ?>平方；<?php echo $vo2['freeze_volume']; ?>立方
                                <?php else: endif; ?>
                            </p>
                            <p style="margin-left: 94px;">
                              <?php if($vo2['quickfreeze_area'] != ''): ?>
                                急冻：<?php echo $vo2['quickfreeze_area']; ?>平方；<?php echo $vo2['quickfreeze_volume']; ?>立方
                                <?php else: endif; ?>
                            </p>
                            <p style="margin-left: 94px;">
                              <?php if($vo2['deepcold_area'] != ''): ?>
                                深冷：<?php echo $vo2['deepcold_area']; ?>平方；<?php echo $vo2['deepcold_volume']; ?>立方
                                <?php else: endif; ?>
                            </p>
                          </span>
                        </li>
                        <!-- <li class="clearfix"><a>可用库容：</a><span><?php echo $vo2['useable_area']; ?>平方；<?php echo $vo2['useable_volume']; ?>立方</span></li> -->
                        <li class="clearfix"><a>增值服务：</a><span><?php echo $vo2['wh_service']; ?></span></li>
                        <li class="clearfix"><a>发票：</a><span><?php echo $vo2['wh_invoice']; ?></span></li>
                        <li class="clearfix"><a>发布日期：</a><span><?php echo $vo2['wh_time']; ?></span></li>
                        <li class="clearfix"><a>仓库实拍图：</a><span><img src="__IMG__<?php echo $vo2['wh_photo']; ?>" style="width: 200px;height: 200px" /></span></li>
                      </ul>
                      <ul class="u-inforUl detail">
                        ...
                        <li class="clearfix"><a>仓库地址：</a>
                          <span>
                            <?php echo $vo2['wh_address']; ?>
                          </span>
                        </li>
                        <li class="clearfix"><a>仓库详细地址：</a><span><?php echo $vo2['wh_address_detail']; ?></span></li>
                      </ul>
                      <ul class="u-inforUl detail">
                        <li class="orderdetail_tit">联系信息</li>
                        <li class="clearfix"><a>联系人：</a><span><?php echo $vo2['wh_contact']; ?></span></li>
                        <li class="clearfix"><a>联系方式：</a><span><?php echo $vo2['wh_phone']; ?></span></li>
                      </ul>
                      <?php endforeach; endif; else: echo "" ;endif; ?>
                    </td>
