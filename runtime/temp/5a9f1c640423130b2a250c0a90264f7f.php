<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"E:\WWW\transport\public/../application/index\view\personalcenterorder\myorder_findgoodsku.html";i:1511165280;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">                            
                                                    ...
                                                    <div class="skin-list1">
                                                        <p class="">
                                                            ...
                                                            <?php elseif($vo['ku_state'] == '2'): ?>
                                                                已支付</br>(待入库)
                                                            <?php elseif($vo['ku_state'] == '3'): if($vo['order_state'] == '2'): ?>
                                                                    交易完成<br/>等待平台支付
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($order_goodskures) != true): if($order_goodskures->isEmpty()): else: ?>
                                            <?php echo $order_goodskures->render(); ?>
                            ...
                            <!-- <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($order_goodskures) != true): if($order_goodskures->isEmpty()): else: ?>
                                            <?php echo $order_goodskures->render(); endif; endif; ?>
                                </div>
                            </div>  -->                          
                        </div>                        
                    </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/myorder_findgoodsku.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
