                        ...
                        <form action="<?php echo url('Personalcenter/goodslist_ku'); ?>" method="get" class="searchform">
                            <div class="m-inforForm clearfix" style="margin-bottom: 20px;">
                                <div class="fl m30">
                                    <p class="fl">仓库地址：</p>
                                    <div class="fr ku">
                                        <input name="whaddress" id="name" class="xm siteinput" type="text" value="<?php echo !empty($whaddress)?$whaddress : '';; ?>" placeholder="请选择冷库地" style="width: 210px;">
                                        <div class="xiala">
                                            <h1><span>确认</span></h1>
                                        </div>
                                    </div>
                                    ...
                                    <tr class="ky-ddKK ky-ddKK1 even">
                                        <td class="zc-lastTr " style="width:15%;">
                                            <div class="skin-list0">
                                                <p title="<?php echo $vo['whaddress']; ?>&nbsp;<?php echo $vo['whaddress_detail']; ?>"> 
                                                <?php echo $vo['whaddress']; ?></br>
                                                <?php echo $vo['whaddress_detail']; ?>
                                                </p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="zc-lastTr " style="width:7%;">
                                            <div class="skin-list2">
                                                <p class="ellipsis">
                                        ...
                                        <td class="skin-border" style="width:10%;">
                                            <div class="zc-positon">
                                                ...
                                                <?php if($vo['order_state'] == '1'): ?>
                                                    ...
                                                    <a href="<?php echo url('Personalcenter/goodslist_ku_del',array('id'=>$vo['id'])); ?>" title="删除" onClick="return confirm('确定要删除吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>  
                                                <?php else: ?>
