<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\WWW\transport\public/../application/index\view\goods\goods_ku.html";i:1510043749;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
								...
								<div class="fr">
				                   	<select name="goods_type" class="siteselect">
										...
										<?php if(is_array($goods_type) || $goods_type instanceof \think\Collection || $goods_type instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
											<option value="<?php echo $v['id']; ?>" <?php if($goods_type2 == $v['id']): ?> selected="selected" <?php endif; ?>><?php echo $v['typename']; ?></option>
							...
							<div class="fl m30 search_margin">
								...
								<div class="fr">
				                   	<select name="order_state" class="siteselect">
				                   		<option >全部</option>
				                   		<option value="1" <?php if($order_state == '1'): ?> selected="selected"<?php endif; ?>>下单</option>
		                   			...
		                   			<tr class="ky-ddKK ky-ddKK1 even">
		                                ...
		                                <td class="zc-lastTr " style="width:15%;">
		                                    <div class="skin-list2">
		                                        <p class="" title=" <?php echo $vo['goods_name']; ?>" style="text-align: center;">
...
<script type="text/javascript">
	...
	$('.tiaozhuan').click(function(){
		...
		$(this).attr('href','/transport/public/index/goods/goods_ku.html?whaddress='+ whaddress+'&is_company='+is_company+'&enter_wh_time='+enter_wh_time+'&goods_type='+goods_type+'&standard_ton='+standard_ton+'&standard_square='+standard_square+'&order_state='+order_state+'&page='+a);
	})
	var totalpage=parseInt($("input[name='totalpage']").val());
