<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"E:\wamp\www\transport\public/../application/index\view\aboutus\honor.html";i:1505958642;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1505981419;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505791287;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<div class="head clearfix" style="overflow: visible;">
        ...
        <div class="container-flued higo-main-content" style="padding:0px;">
            ...
            <div class="ziye_bj">
                <div class="ziye_tu">
                    <img src="__PUBLIC__/images/ryzz.jpg">
                </div>
            </div>
            <div class="zy_gywm">
                <div class="ejdh">
                ...
                <div class="zynr_db">
                    ...
                    <!--内容-->
                    <div class="gsjj_nr" style="min-height: 400px;">
                        <p style="font-size: 16px;">2016年全国冷链物流百强企业</p>
                    </div>
                </div>
            </div>
            <!-- 底部结束开始 -->
