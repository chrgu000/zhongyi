<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\wamp\www\transport\public/../application/index\view\foot\auth_flowpath.html";i:1505959547;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506071803;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>认证指南</title>
    ...
    <div class="wrap-1200">
        ...
        <div class="locationBox">
            <div class="pages_style">
                <div class="locationBox_name"><i class="glyphicon glyphicon-map-marker"></i>&nbsp;您现在的位置：<a href="<?php echo url('Index/index'); ?>">首页</a>&gt;<a href="<?php echo url('Foot/register_flowpath'); ?>">用户指南</a>&gt;<a href="<?php echo url('Foot/auth_flowpath'); ?>">认证指南</a></div>
            </div>
        </div>
         <!--具体内容-->
        <div class="page_content clearfix ">
            <div class="page_Section">
                <div class="Section_list">
                    ...
                    <ul class="list">
                        ...
                        <li class="hover"><a href="<?php echo url('Foot/auth_flowpath'); ?>"><span class="fa fa-angle-left icon"></span>认证指南</a></li>
            ...
            <div class="page_detailed">
                <div class="page_Switchbox">
                    <div class="bd">
                        <h2 class="tit">认证指南</h2>
                        <div class="orderdes orderdes3" style="margin-left: 100px;">
                            <p class="noborder" style="margin-top: 0px;" ><span >1、注册成功登陆后，点击导航“个人中心”进入个人中心页面；</span></p>
                            <p class="noborder"><span>2、选择您对应的身份点击进入认证页面；</span></p>
                            <p class="noborder"><span>3、按照页面要求正确输入您的个人信息（如需上传图片，请选择不超过2M大小的图片）；</span></p>
                            <p class="noborder"><span>4、信息输入完毕后，点击“提交”按钮，平台会在2~3个工作日内对您的信息进行审核；如果审核不通过，则需要您重新提交资质信息。</span></p>
                            <p class="noborder"><span>温馨提示：请确保您提交信息的准确性以及图片的清晰度，否则会造成认证审核失败耽误认证进度。如有疑问，可致电：0371—55172118</span></p>
                        </div>
                    </div>
                </div>
            </div>
