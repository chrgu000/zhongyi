<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\zhongyi\public/../application/admin\view\system\img-edit.html";i:1524490363;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('System/imgedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
