<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\WWW\transport\public/../application/index\view\goods\goods_car.html";i:1511247555;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522316551;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
				...
				<div class="m-infonavContent2 mj-xlxx">
						<div class="m-inforForm clearfix" style="margin-bottom: 20px;">
							...
							<div class="clearfix fl m30">
								<p class="fl">始&nbsp;发&nbsp;地&nbsp;：</p>
			                    <div class="fr ku">
		                            <input  name="starting_address" id="name" class="xm" type="text" placeholder="请输入始发地" style="width: 200px;" value="<?php echo !empty($starting_address)?$starting_address : '';; ?>">
		                            <div class="xiala">
		                                <h1><span>确认</span></h1>
		                            </div>
		                        </div>
							...
							<div class="clearfix fl m30">
								<p class="fl">目&nbsp;的&nbsp;地&nbsp;&nbsp;：</p>
				                <div class="fr ku1">
		                            <input  name="destination" id="name" class="xm" type="text" placeholder="请输入目的地" style="width: 200px;" value="<?php echo !empty($destination)?$destination : '';; ?>">
		                            <div class="xiala1">
		                                <h1><span>确认</span></h1>
		                            </div>
		                        </div> 
						...
						<table style="min-width:1136px;">
		                                ...
		                                <td class="" style="width: 15%">
		                                    <div class="skin-list1">
												...
												<?php if($vo['is_company'] == '1'): ?>
													<span class="zybtn" title="易冷链自营">自营</span>
												<?php endif; ?>
													&nbsp;<span><?php echo $vo['contact']; ?></span></br>
                   		...
                   		<div class="pages">
							<div id="paging1" class="page light-theme simple-pagination">
								<!-- <?php echo $goodsres->currentPage(); ?> -->
						        <?php echo $goodsres->render(); ?>
						        <!-- <?php echo $goodsres->lastPage(); ?> -->
...
<script type="text/javascript">
	...
	$('.tiaozhuan').click(function(){
		...
		$(this).attr('href','/transport/public/index/goods/goods_car.html?goods_name='+goodsname+'&starting_address='+starting_address+'&destination='+destination+'&standard_ton='+standard_ton+'&standard_square='+standard_square+'&car_length='+car_length+'&car_type='+car_type+'&is_company='+is_company+'&start_loadingtime='+start_loadingtime+'&time='+time+'&page='+a);
