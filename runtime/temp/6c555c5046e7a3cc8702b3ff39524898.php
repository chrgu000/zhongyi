<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\WWW\zhongyi\public/../application/admin\view\sick\add.html";i:1524621280;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Sick/add'); ?>" method="post" class="form form-horizontal" id="form-admin-add">
	    <div class="row cl">
