<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"E:\WWW\transport\public/../application/index\view\personalcenter\shipperauth.html";i:1507620781;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1508719130;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1507533842;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1507716955;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['check_state'] == '1'): ?>
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <p class="p1 active">个体货主认证</p>
                <p class="p2">公司货主认证</p>
            </div>
            <div class="jg">尊敬的用户！为了方便进行交易请您进行实名认证！打<span>*</span>为必填项</div>
            <!-- 个体货主 -->
            <form action="<?php echo url('Personalcenter/shipperauth'); ?>" method="post" enctype="multipart/form-data" class="form1" onSubmit="return checkshipperauth();">
            <input type="hidden" name="type" value="个体货主">
            <input type="hidden" name="check_state" value="3">
                <div class="g-content g-content0">
                    <ul>
                        ...
                        <li class="u-start c-startEnd list clearfix validate-parent">
                            ...
                            <!--<input type="text" class="bigInput fl" />-->
                            <div class="mj-inptext fl">
                                <input onblur="sfzReg(this)" name="identity_id" id="companyName" type="text" placeholder="" autocomplete="off" maxlength="18">
                        ...
                        <li class="u-start c-startEnd list clearfix">
                            <p class="fl add-p"><span>*</span>个体经营许可证：</p>
            ...
            <!-- 公司货主 -->
            <form action="<?php echo url('Personalcenter/shipperauth1'); ?>" method="post" enctype="multipart/form-data" class="form2" style="display: none;">
            <input type="hidden" name="type" value="公司货主">
            <input type="hidden" name="check_state" value="3">
                <div class="g-content g-content0">
                    <ul>
                        <li class="u-start c-startEnd list clearfix validate-parent">
                        ...
                        <li class="u-start c-startEnd list clearfix validate-parent">
                            <p class="fl add-p "><span>*</span>公司名称：</p>
                            <!--<input type="text" class="bigInput fl" />-->
                            <div class="mj-inptext fl">
                                <input onblur="mzReg(this)" name="company_name" id="companyName" type="text" placeholder="" autocomplete="off">
                                <label class="hide" style="color:rgb(225, 60, 60);">请输入公司名称</label>
                            </div>
                            <ul class="u-msg fl">
                                <li><span class="s-cl999"></span></li>
                                <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                        ...
                        <li class="u-start c-startEnd list clearfix">
                            <p class="fl add-p"><span>*</span>营业执照：</p>
                             <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                <div class="img_show">
