<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"E:\WWW\transport\public/../application/index\view\personalcenterorder\myorder_findku.html";i:1511165151;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1522318885;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="person-right fr mjy-add mj-pro0">
            <div class="mj-adds clearfix mj-addNav">
                <?php if($userres['type'] == '物流公司'): ?>
                    ...
                    <a href="<?php echo url('Personalcenterorder/myorder_findku'); ?>"><p class="p2  active">货找库订单</p></a>
                    <a href="<?php echo url('Personalcenterorder/myorder_findgoodsku'); ?>"><p class="p3 ">库找货订单</p></a>
            ...
            <div class="m-infortabBack" style="margin-top: 20px;">
                <div id="m-infonavCont">
                    <div class="m-infonavContent2 mj-xlxx">
                        <form action="<?php echo url('Personalcenterorder/myorder_findku'); ?>" method="get" class="searchform">
                                ...
                                <div class="clearfix fl m30">
                                    ...
                                    <div class="fr">
                                        <select name="order_state" class="siteselect" style="width: 150px;">
                                            ...
                                            <option value="2" <?php if($order_state == '2'): ?> selected="selected"<?php endif; ?> >待支付</option>
                                            <option value="3" <?php if($order_state == '3'): ?> selected="selected"<?php endif; ?> >待入库</option>
                                            <option value="4" <?php if($order_state == '4'): ?> selected="selected"<?php endif; ?> >已入库</option>
                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">                            
                            <table style="min-width:960px;" class="table1">
                                <tbody>
                                    ...
                                    <?php if(empty($goodsres) != true): if(empty($order_warehouseres) != true): if(is_array($order_warehouseres) || $order_warehouseres instanceof \think\Collection || $order_warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_warehouseres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                     
                                                <tr class="ky-ddKK ky-ddKK1 odd">
                                                    <td class="" style="width:10%;">
                                                        <div class="skin-list1">
                                                            ...
                                                            <?php if(is_array($goodsres) || $goodsres instanceof \think\Collection || $goodsres instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($i % 2 );++$i;if($vo['goods_id'] == $v2['id']): ?>
                                                                    ...
                                                                    <p><?php echo $v2['standard_ton']; ?>吨 <?php echo $v2['standard_square']; ?>方</p>
                                                    ...
                                                    <td class="" style="width:15%;">
                                                        <div class="skin-list2">
                                                            <div class="czh-posi">
                                                                <?php if(is_array($warehouseres) || $warehouseres instanceof \think\Collection || $warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $warehouseres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['wh_id'] == $v1['id']): ?>
                                                                        <p><?php echo $v1['wh_name']; ?></p>
                                                                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="zc-lastTr " style="width:11%;">
                                                        <div class="skin-list3">
                                                            <?php if(is_array($warehouseres) || $warehouseres instanceof \think\Collection || $warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $warehouseres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['wh_id'] == $v1['id']): ?>
                                                                    <p class="ellipsis" style="text-align: left;" title="<?php echo $v1['wh_address']; ?>">&nbsp;<?php echo $v1['wh_address']; ?></p>
                                                                    <p class="ellipsis" style="text-align: left;" title="<?php echo $v1['wh_address_detail']; ?>">&nbsp;<?php echo $v1['wh_address_detail']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    <td class="" style=" width:23%;">
                                                        <div class="skin-list">
                                                            <?php if(is_array($warehouseres) || $warehouseres instanceof \think\Collection || $warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $warehouseres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['wh_id'] == $v1['id']): ?>
                                                                    <p>
                                                                        <?php if($v1['normal_area'] != ''): ?>
                                                                            常温：&nbsp;<?php echo $v1['normal_area']; ?>平方/<?php echo $v1['normal_volume']; ?>立方
                                                                        <?php else: endif; ?>
                                                                    </p>
                                                                    <p>
                                                                        <?php if($v1['coldstorage_area'] != ''): ?>
                                                                            冷藏：&nbsp;
                                                                            <?php echo $v1['coldstorage_area']; ?>平方/<?php echo $v1['coldstorage_volume']; ?>立方
                                                                        <?php else: endif; ?>
                                                                    </p>
                                                                    <p>
                                                                        <?php if($v1['freeze_area'] != ''): ?>
                                                                            冷冻：&nbsp;<?php echo $v1['freeze_area']; ?>平方/<?php echo $v1['freeze_volume']; ?>立方
                                                                        <?php else: endif; ?>
                                                                    </p>

                                                                    <p>
                                                                        <?php if($v1['quickfreeze_area'] != ''): ?>
                                                                            急冻：&nbsp;
                                                                            <?php echo $v1['quickfreeze_area']; ?>平方/<?php echo $v1['quickfreeze_volume']; ?>立方
                                                                        <?php else: endif; ?>
                                                                    </p>
                                                                    <p>
                                                                        <?php if($v1['deepcold_area'] != ''): ?>
                                                                            深冷：&nbsp;
                                                                            <?php echo $v1['deepcold_area']; ?>平方/<?php echo $v1['deepcold_volume']; ?>立方
                                                                        <?php else: endif; ?>
                                                                    </p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    ...
                                                    <td class="" style="width: 7%">
                                                        <div class="skin-list1">
                                                            <p><?php echo $vo['order_money']; ?>&nbsp;元</p>
                                                        </div>
                                                    </td>
                                                    <td class="" style="width: 8%">
                                                        <div class="skin-list1">
                                                            <?php if(is_array($warehouseres) || $warehouseres instanceof \think\Collection || $warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $warehouseres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($vo['wh_id'] == $v1['id']): ?>
                                                                    <p class="ellipsis"><?php echo $v1['wh_contact']; ?></br><?php echo $v1['wh_phone']; ?></p>
                                                                <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <?php if($vo['pay_state'] == '1'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/whunpay_cancel',array('id'=>$vo['id'])); ?>" class="btn1" title="取消订单" datatype="1" onClick="return confirm('确定要取消订单吗？')"><span class="glyphicon glyphicon-remove-circle"></span></a>
                                                            </div>
                                                        </td>
                                                    <?php elseif($vo['pay_state'] == '2'): ?>
                                                        <td class="" style="width: 7%">
                                                            ...
                                                            <div class="modal fade" id="<?php echo $vo['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="md-content">
                                                                      ...
                                                                      <div>
                                                                        <ul class="order_ku">
                                                                          <form action="<?php echo url('Personalcenterorder/alipay2'); ?>" method="post" class="rz-Form">
                                                    ...
                                                    <?php elseif($vo['pay_state'] == '3'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/whpaid_cancel',array('id'=>$vo['id'])); ?>" class="btn1" title="取消订单" datatype="1" onClick="return confirm('确定要取消订单吗？')"><span class="glyphicon glyphicon-remove-circle"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/goodsinku',array('id'=>$vo['id'])); ?>" class="btn1" title="确认订单完成" onClick="return confirm('确定此订单货物已入库了吗？')" datatype="1"><span class="glyphicon glyphicon-ok-circle"></span></a>
                                                            </div>
                                                        </td>
                                                    <?php elseif($vo['pay_state'] == '4'): ?>
                                                        <td class="" style="width: 7%">
                                                            <div class="zc-positon"> 
                                                                <a href="<?php echo url('Personalcenterorder/acceptorder_goodsku_detail1',array('id'=>$vo['id'])); ?>" class="btn1" title="查看订单详情" datatype="1"><span class="glyphicon glyphicon-info-sign"></span></a>
                                                                <a href="<?php echo url('Personalcenterorder/goods_del2',array('id'=>$vo['id'])); ?>" title="删除订单" onClick="return confirm('确定要删除此订单吗？')" class="btn1" ><span class="fa fa-trash-o"></span></a>
                                                            </div>
                                                        </td>
                                                    <?php elseif($vo['pay_state'] == '5'): ?>
                                                        <td class="" style="width: 7%">
                            ...
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($goodsres) != true): if($order_warehouseres->isEmpty()): else: ?>
                                            <?php echo $order_warehouseres->render(); ?>
                            ...
                            <!-- <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                    <?php if(empty($goodsres) != true): if($order_warehouseres->isEmpty()): else: ?>
                                            <?php echo $order_warehouseres->render(); endif; endif; ?>
                                </div>
                            </div> -->                            
                        </div>                        
                    </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        $(this).attr('href','/transport/public/index/personalcenterorder/myorder_findku.html?order_state='+order_state+'&order_number='+order_number+'&time='+time+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
