                        ...
                        <div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active nullwrap" style="padding-top: 0px;">
                            <table style="min-width:960px;">
                                <tbody>
                                    ...
                                    <?php if($pathres != ''): if(empty($order_pathres) != true): if(is_array($order_pathres) || $order_pathres instanceof \think\Collection || $order_pathres instanceof \think\Paginator): $i = 0; $__LIST__ = $order_pathres;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂时没有数据</p>" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>                    
                                            ...
                                            <?php endforeach; endif; else: echo "<p class='nulltext'>暂时没有数据</p>" ;endif; endif; endif; ?>
                                </tbody>
                            </table>
                            <div class="pages">
                                <div id="paging1" class="page light-theme simple-pagination" style="text-align: center;" >
                                <?php if(empty($order_pathres) != true): ?>
                                    <?php echo $order_pathres->render(); endif; ?>
                                </div>
                            </div> 
                        </div>
                    </div>
