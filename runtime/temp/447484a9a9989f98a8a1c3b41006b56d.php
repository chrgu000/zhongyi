<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\WWW\transport\public/../application/index\view\foot\contactus.html";i:1506406013;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>联系我们</title>
    ...
    <div class="wrap-1200">
        ...
        <div class="locationBox">
            <div class="pages_style">
                <div class="locationBox_name"><i class="glyphicon glyphicon-map-marker"></i>&nbsp;您现在的位置：<a href="<?php echo url('Index/index'); ?>">首页</a>&gt;<a href="<?php echo url('Foot/aboutplant'); ?>">关于平台</a>&gt;<a href="<?php echo url('Foot/contactus'); ?>">联系我们</a></div>
            </div>
        </div>
         <!--具体内容-->
        <div class="page_content clearfix ">
            <div class="page_Section">
                <div class="Section_list">
                    ...
                    <ul class="list">
                        <li ><a href="<?php echo url('Foot/aboutplant'); ?>"><span class="fa fa-angle-left icon"></span>平台介绍</a></li>
                        <li class="hover"><a href="<?php echo url('Foot/contactus'); ?>"><span class="fa fa-angle-left icon"></span>联系我们</a></li>
                    </ul>
                    <div class="Phone">
                        <ul class=" clearfix">
                            <li class="img"></li>
            ...
            <div class="page_detailed">
                <div class="page_Switchbox">
                    <div class="bd">
                        ...
                        <div class="orderdes orderdes3" style="margin-top: 50px; margin-left: 100px;">
                            <p style="margin-top: 0px;"><span class="glyphicon glyphicon-earphone ordericon"></span>&nbsp;&nbsp;&nbsp;联系电话：&nbsp;<span style="font-size:20px;">0371—55172118</span></p>
                            <p><span class="fa fa-envelope ordericon"></span>&nbsp;&nbsp;&nbsp;电子邮箱：&nbsp;<span style="font-size:20px;">xsll@zih718.com</span></p>
                            <p><span class="fa fa-map-marker ordericon"></span>&nbsp;&nbsp;&nbsp;地址：&nbsp;<span style="font-size:20px;">河南省郑州市经开区经北四路与十七大街交叉口</span></p>
                        </div>
                    </div>
                </div>
            </div>
