					...
					<form action="<?php echo url('Warehouse/warehouse'); ?>" method="get" style="margin-bottom: 20px;">
						<div class="m-inforForm clearfix">
							<div class="clearfix fl m30">
								<p class="fl">所&nbsp;在&nbsp;地&nbsp;：</p>
                            	<div class="fr ku">
		                            <input  name="wh_address" id="name" class="xm" type="text" placeholder="请输入仓库所在地" style="width: 200px;">
		                            <div class="xiala">
		                                <h1><span>确认</span></h1>
		                            </div>
		                        </div>
					...
					<div class="czh-Bottom m-formBottom clearfix timeTop f14 cz-active ">
						<table style="min-width:1136px;">
                           	<tbody>
                            	...
                            	<?php if(is_array($warehouseres) || $warehouseres instanceof \think\Collection || $warehouseres instanceof \think\Paginator): $i = 0; $__LIST__ = $warehouseres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>           			
	                    		<tr class="ky-ddKK ky-ddKK1 odd">
	                                ...
	                                <td class="" style="width: 12%">
	                                    <div class="skin-list1">
											<p class="ellipsis"><?php echo $vo['wh_contact']; ?></br>
		                                ...
		                                <td class="skin-border" style="width:10%;">
		                                	<div class="zc-positon">
												<?php if($vo['order_state'] == '1'): ?>
													...
													<a href="" class="u-aNext u-aNext1 u-aNext3" >您的仓库</a>
													<?php else: ?>
