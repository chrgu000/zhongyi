<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\zhongyi\public/../application/admin\view\study\add_video.html";i:1524474382;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
    <form action="<?php echo url('Study/add_video'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>上传视频：</label>
            <div class="formControls col-6"> 
                <span class="btn-upload form-group">
                    <input class="input-text upload-url" type="text" name="name" id="uploadfile-2" style="width:500px" placeholder="点击上传视频">
                    <a href="javascript:void();" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 浏览文件夹</a>
                    <input type="file" multiple name="name"  class="input-file">
                </span>
            </div>
        </div>
        <div class="row cl">
