...
<div class="personCenter">
    ...
    <?php if(is_array($userres) || $userres instanceof \think\Collection || $userres instanceof \think\Paginator): $i = 0; $__LIST__ = $userres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['check_state'] == '1'): ?>
                        ...
                        <ul>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                ...
                                <div class="mj-inptext fl">
                                    ...
                                    <p class="fl add-p "><?php echo $userres[0]['real_name']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                ...
                                <div class="mj-inptext fl">
                                    ...
                                    <p class="fl add-p "><?php echo $userres[0]['identity_id']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                ...
                                <div class="mj-inptext fl">
                                    ...
                                    <p class="fl add-p "><?php echo $userres[0]['car_id']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">行驶证：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        <img src="__IMG__<?php echo $userres[0]['driver_card']; ?>" id="show">
                                    </div>
        ...
        <?php elseif($userres[0]['type'] == '物流公司'): ?>
            <!-- 物流公司认证信息 -->
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                        ...
                        <ul>
                            ...
                            <li class="u-start c-startEnd list clearfix validate-parent">
                                ...
                                <div class="mj-inptext fl">
                                    ...
                                    <p class="fl add-p "><?php echo $userres[0]['company_name']; ?></p>
                                </div>
                                <ul class="u-msg fl">
                                    <li><span class="s-cl999"></span></li>
                                    <li><i class="mjFont col_waring"></i><span class="text_error"></span></li>
                                ...
                                <p class="fl add-p">营业执照：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        ...
                                        <img src="__IMG__<?php echo $userres[0]['business_card']; ?>" id="show">
                                    </div>
                                    <!-- <span class="fileinput-button">
                                        <span>点击上传</span>
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                ...
                                <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        ...
                                        <img src="__IMG__<?php echo $userres[0]['road_permit']; ?>" id="show">
                                    </div>
                                    <!-- <span class="fileinput-button">
                                        <span>点击上传</span>
        ...
        <?php elseif($userres[0]['type'] == '个体货主'): ?>
            <!-- 个体货主认证信息 -->
            <div class="person-right fr mjy-add mj-pro0">
                <div class="mj-adds clearfix mj-addNav">
                            ...
                            <li class="u-start c-startEnd list clearfix">
                                <p class="fl add-p">个体经营许可证：</p>
                                 <div class="mj-inptext fl rz-divWidth" style="margin-left:12px; margin-top:10px;">
                                    <div class="img_show">
                                        <!-- <img src="__PUBLIC__/images/sci.png" id="show"> -->
                                        <img src="__IMG__<?php echo $userres[0]['peison_business']; ?>" id="show">
                                    </div>
                                   <!--  <span class="fileinput-button">
                                        <span>点击上传</span>
