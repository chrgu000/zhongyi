<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\zhongyi\public/../application/admin\view\photo\add_photo.html";i:1524467187;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Photo/add_photo'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
		<div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>名医图片：</label>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>名医简介：</label>
