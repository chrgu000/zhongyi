<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\wamp\www\transport\public/../application/admin\view\web\link-list.html";i:1506419570;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('Web/linkadd'); ?>" class="btn btn-danger radius" >
		    ...
		    <tbody>
		       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			    <tr class="text-c">
				    ...
				    <td class="td-manage">
                        <a title="删除" href="<?php echo url('Web/linkdel',array('id'=>$v['id'])); ?>"  onclick="return confirm('确定要删除吗？')" class="ml-5" style="text-decoration:none">
