<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\wamp\www\transport\public/../application/index\view\foot\deal_flowpath.html";i:1506309059;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1506071803;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505989080;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>交易指南</title>
    ...
    <div class="wrap-1200">
        ...
        <div class="locationBox">
            <div class="pages_style">
                <div class="locationBox_name"><i class="glyphicon glyphicon-map-marker"></i>&nbsp;您现在的位置：<a href="<?php echo url('Index/index'); ?>">首页</a>&gt;<a href="<?php echo url('Foot/register_flowpath'); ?>">用户指南</a>&gt;<a href="<?php echo url('Foot/deal_flowpath'); ?>">交易指南</a></div>
            </div>
        </div>
         <!--具体内容-->
        <div class="page_content clearfix ">
            <div class="page_Section">
                <div class="Section_list">
                    ...
                    <ul class="list">
                        ...
                        <li class="hover"><a href="<?php echo url('Foot/deal_flowpath'); ?>"><span class="fa fa-angle-left icon"></span>交易指南</a></li>
            ...
            <div class="page_detailed">
                <div class="page_Switchbox">
                    <div class="bd">
                        <h2 class="tit">交易指南</h2>
                        <div class="orderdes orderdes3" style="margin-left: 100px;">
                            <p class="noborder" style="margin-top: 0px;" ><span>1、在您选择车辆，货物，仓库时，为规避因协商不当引起的交易纠纷，请联系车主，货主，库主并核实详细信息及重要事项；</span></p>
                            <p class="noborder"><span>2、用户需按平台的规章制度进行业务操作，不得违反平台相关章程。一方承接订单后需执行订单。订单出现异常，请及时和对方沟通，必要时平台负责监督协商；</span></p>
                            <p class="noborder"><span>3、车主商家运输途中如因手续不全，车况不良造成的事故，超载罚款等，由其承担相应责任；</span></p>
                            <p class="noborder"><span>4、运输途中出现异常情况，承运方应及时与托运方沟通并提供解决方案。平台不参与双方的纠纷处理；</span></p>
                            <p class="noborder"><span>5、承运方的运输要求应当按照托运方提出的标准执行。当承运方未按照托运方要求运输时，出现问题由双方共同协商解决，平台不参与双方的纠纷处理；</span></p>
                            <p class="noborder"><span>6、平台用户必须按照规定操作陆港易冷链平台，严禁非法利用平台或进行任何违法违规操作；</span></p>
                        </div>
                    </div>
                </div>
            </div>
