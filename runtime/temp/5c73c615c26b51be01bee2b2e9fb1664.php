<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"E:\WWW\transport\public/../application/index\view\personalcenter\warehouselist.html";i:1510211942;s:68:"E:\WWW\transport\public/../application/index\view\common\header.html";i:1513838096;s:66:"E:\WWW\transport\public/../application/index\view\common\left.html";i:1511158695;s:68:"E:\WWW\transport\public/../application/index\view\common\footer.html";i:1509431569;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                        ...
                        <form action="<?php echo url('Personalcenter/warehouselist'); ?>" method="get" class="searchform">
                                ...
                                <div class="clearfix fl m30 ">
                                    ...
                                    <div class="fr">
                                        <select name="order_state" class="siteselect" style="width: 200px;">
                                            <option >全部</option>
                                            <option value="1" <?php if($order_state == '1'): ?> selected="selected"<?php endif; ?> >未被下单</option>
                                            <option value="2" <?php if($order_state == '2'): ?> selected="selected"<?php endif; ?> >已被下单</option>
                            ...
                            <div class="m-inforForm clearfix" style="margin-top: 20px;" >
                                ...
                                <div class="clearfix fl m30 search_margin">
                                    <p class="fl">仓库类型：</p>
                                    <div style="display: inline-block;">
                                        <select name="wh_type" class="siteselect" style="width: 200px;">
                                            <option >不限</option>           
                                            <option value="平堆库" <?php if($wh_type == '平堆库'): ?> selected="selected"<?php endif; ?> >平堆库</option>
                                            <option value="货架库" <?php if($wh_type == '货架库'): ?> selected="selected"<?php endif; ?> >货架库</option>
                                            <option value="自动化库" <?php if($wh_type == '自动化库'): ?> selected="selected"<?php endif; ?> >自动化库</option>
                                            <option value="保税库" <?php if($wh_type == '保税库'): ?> selected="selected"<?php endif; ?> >保税库</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $('.tiaozhuan').click(function(){
        ...
        var wh_type=$("select[name='wh_type']").val();
        if(a<=0){
            a=1;
        }
        if(a>totalpage){
        ...
        $(this).attr('href','/transport/public/index/personalcenter/warehouselist.html?wh_address='+wh_address+'&order_state='+order_state+'&wh_time='+wh_time+'&wh_type='+wh_type+'&page='+a);
    })
    var totalpage=parseInt($("input[name='totalpage']").val());
