<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\wamp\www\transport\public/../application/admin\view\user\businessimg-edit.html";i:1506419362;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('User/businessimg_edit'); ?>" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
		...
		<div class="row cl">
			<div class="col-9 col-offset-3">
				...
				<a href="<?php echo url('User/edit',array('id'=>$id)); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
			</div>
		</div>
	</form>
</div>
