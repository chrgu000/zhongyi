<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\wamp\www\transport\public/../application/index\view\news\news.html";i:1505960509;s:73:"E:\wamp\www\transport\public/../application/index\view\common\header.html";i:1505978831;s:73:"E:\wamp\www\transport\public/../application/index\view\common\footer.html";i:1505791287;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>新闻资讯</title>
...
<div class="container-flued" style="background: #f5f5f5;">
    ...
    <div class="nav clearfix wrap-1200" style="padding: 50px 0px; min-height: 500px;">
        <ul>
            ...
            <li class="news_list clearfix">
                <a href="<?php echo url('news/newsdetail',array('id'=>$vo['id'])); ?>">
                    <div class="fl news_l">
                        <p style="font-size: 14px;margin-top: 20px;"><span class="detestyle"  style="font-size: 20px; "><?php echo $vo['articletime']; ?></span></p>
                    </div>
                    <div class="fl news_r">
