                    ...
                    <form action="<?php echo url('Personalcenter/pathlist'); ?>" method="get" class="searchform">
                        <div class="m-inforForm clearfix" style="margin-bottom: 20px;">
                            <div class="clearfix fl m30">
                                <p class="fl">始&nbsp;发&nbsp;地&nbsp;：</p>
                                <div class=" fr ku">
                                    <input name="startsite" id="name" class="xm siteinput" type="text" placeholder="请输入始发地" style="width: 210px;">
                                    <div class="xiala">
                                        <h1><span>确认</span></h1>
                                    </div>
                                </div>
                            ...
                            <div class="clearfix fl m30">
                                <p class="fl">目&nbsp;的&nbsp;地：</p>
                                <div class="fr ku1">
                                    <input name="endsite" id="name" class="xm siteinput" type="text" placeholder="请输入目的地" style="width: 210px;">
                                    <div class="xiala1">
                                        <h1><span>确认</span></h1>
                                    </div>
                                </div>
